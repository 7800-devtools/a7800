...
/***************************************************************************
    PALETTE - 26.7 PHASE SHIFT - "WARM" via CRT_V2_STD
***************************************************************************/
...
#define NTSC_HUE1_PAL_HUE2 \
	rgb_t(0x27,0x00,0x00), rgb_t(0x3D,0x1F,0x00), rgb_t(0x52,0x37,0x00), rgb_t(0x64,0x4C,0x00), \
    	rgb_t(0x76,0x5F,0x00), rgb_t(0x87,0x71,0x00), rgb_t(0x97,0x82,0x00), rgb_t(0xA7,0x92,0x00), \
    	rgb_t(0xB6,0xA2,0x00), rgb_t(0xC5,0xB2,0x00), rgb_t(0xD4,0xC1,0x00), rgb_t(0xE3,0xD0,0x00), \
    	rgb_t(0xF1,0xDE,0x0A), rgb_t(0xFE,0xEC,0x26), rgb_t(0xFF,0xFA,0x3D), rgb_t(0xFF,0xFF,0x51   )

#define PAL_HUE1 \
	rgb_t(0x00,0x1F,0x00), rgb_t(0x00,0x36,0x00), rgb_t(0x09,0x4B,0x00), rgb_t(0x25,0x5E,0x00), \
	rgb_t(0x3C,0x70,0x00), rgb_t(0x50,0x82,0x00), rgb_t(0x63,0x92,0x00), rgb_t(0x75,0xA2,0x00), \
	rgb_t(0x86,0xB2,0x00), rgb_t(0x96,0xC1,0x00), rgb_t(0xA6,0xCF,0x00), rgb_t(0xB6,0xDE,0x00), \
	rgb_t(0xC5,0xEC,0x10), rgb_t(0xD3,0xFA,0x2B), rgb_t(0xE2,0xFF,0x41), rgb_t(0xF0,0xFF,0x55   )

#define NTSC_HUE2_PAL_HUE3 \
	rgb_t(0x5B,0x00,0x00), rgb_t(0x6D,0x00,0x00), rgb_t(0x7F,0x1D,0x00), rgb_t(0x8F,0x35,0x00), \
    	rgb_t(0x9F,0x4A,0x00), rgb_t(0xAF,0x5D,0x00), rgb_t(0xBE,0x6F,0x00), rgb_t(0xCD,0x80,0x00), \
    	rgb_t(0xDB,0x91,0x00), rgb_t(0xEA,0xA1,0x00), rgb_t(0xF8,0xB1,0x12), rgb_t(0xFF,0xC0,0x2C), \
    	rgb_t(0xFF,0xCF,0x42), rgb_t(0xFF,0xDD,0x55), rgb_t(0xFF,0xEB,0x68), rgb_t(0xFF,0xF9,0x79   )

#define NTSC_HUE3_PAL_HUE4 \
	rgb_t(0x77,0x00,0x00), rgb_t(0x88,0x00,0x00), rgb_t(0x98,0x00,0x00), rgb_t(0xA8,0x1E,0x00), \
    	rgb_t(0xB7,0x35,0x00), rgb_t(0xC6,0x4A,0x00), rgb_t(0xD5,0x5D,0x15), rgb_t(0xE3,0x6F,0x2E), \
    	rgb_t(0xF1,0x81,0x44), rgb_t(0xFF,0x91,0x58), rgb_t(0xFF,0xA1,0x6A), rgb_t(0xFF,0xB1,0x7B), \
    	rgb_t(0xFF,0xC0,0x8C), rgb_t(0xFF,0xCF,0x9C), rgb_t(0xFF,0xDD,0xAC), rgb_t(0xFF,0xEB,0xBB   )

#define NTSC_HUE4_PAL_HUE5 \
	rgb_t(0x7C,0x00,0x00), rgb_t(0x8C,0x00,0x18), rgb_t(0x9D,0x00,0x31), rgb_t(0xAC,0x09,0x46), \
	rgb_t(0xBB,0x25,0x5A), rgb_t(0xCA,0x3C,0x6C), rgb_t(0xD9,0x50,0x7D), rgb_t(0xE7,0x63,0x8E), \
	rgb_t(0xF5,0x75,0x9E), rgb_t(0xFF,0x86,0xAE), rgb_t(0xFF,0x96,0xBD), rgb_t(0xFF,0xA6,0xCC), \
	rgb_t(0xFF,0xB5,0xDA), rgb_t(0xFF,0xC5,0xE9), rgb_t(0xFF,0xD3,0xF7), rgb_t(0xFF,0xE2,0xFF   )

#define NTSC_HUE5_PAL_HUE6 \
	rgb_t(0x69,0x00,0x6D), rgb_t(0x7B,0x00,0x7E), rgb_t(0x8B,0x00,0x8F), rgb_t(0x9B,0x00,0x9F), \
	rgb_t(0xAB,0x1F,0xAE), rgb_t(0xBA,0x37,0xBE), rgb_t(0xC9,0x4C,0xCC), rgb_t(0xD8,0x5F,0xDB), \
	rgb_t(0xE6,0x71,0xE9), rgb_t(0xF4,0x82,0xF7), rgb_t(0xFF,0x92,0xFF), rgb_t(0xFF,0xA2,0xFF), \
	rgb_t(0xFF,0xB2,0xFF), rgb_t(0xFF,0xC1,0xFF), rgb_t(0xFF,0xD0,0xFF), rgb_t(0xFF,0xDE,0xFF   )

#define NTSC_HUE6_PAL_HUE7 \
	rgb_t(0x3F,0x00,0xAD), rgb_t(0x53,0x00,0xBC), rgb_t(0x66,0x00,0xCB), rgb_t(0x78,0x09,0xD9), \
	rgb_t(0x88,0x26,0xE7), rgb_t(0x99,0x3C,0xF5), rgb_t(0xA8,0x51,0xFF), rgb_t(0xB8,0x63,0xFF), \
	rgb_t(0xC7,0x75,0xFF), rgb_t(0xD5,0x86,0xFF), rgb_t(0xE4,0x97,0xFF), rgb_t(0xF2,0xA6,0xFF), \
	rgb_t(0xFF,0xB6,0xFF), rgb_t(0xFF,0xC5,0xFF), rgb_t(0xFF,0xD3,0xFF), rgb_t(0xFF,0xE2,0xFF   )

#define NTSC_HUE7_PAL_HUE8 \
	rgb_t(0x00,0x00,0xC9), rgb_t(0x14,0x00,0xD8), rgb_t(0x2D,0x00,0xE6), rgb_t(0x43,0x1E,0xF4), \
	rgb_t(0x57,0x36,0xFF), rgb_t(0x69,0x4B,0xFF), rgb_t(0x7B,0x5E,0xFF), rgb_t(0x8B,0x70,0xFF), \
	rgb_t(0x9B,0x81,0xFF), rgb_t(0xAB,0x92,0xFF), rgb_t(0xBA,0xA2,0xFF), rgb_t(0xC9,0xB1,0xFF), \
	rgb_t(0xD8,0xC0,0xFF), rgb_t(0xE6,0xCF,0xFF), rgb_t(0xF4,0xDE,0xFF), rgb_t(0xFF,0xEC,0xFF   )

#define NTSC_HUE8_PAL_HUE9 \
	rgb_t(0x00,0x00,0xC2), rgb_t(0x00,0x00,0xD1), rgb_t(0x00,0x1E,0xDF), rgb_t(0x00,0x36,0xED), \
	rgb_t(0x17,0x4B,0xFB), rgb_t(0x30,0x5E,0xFF), rgb_t(0x45,0x70,0xFF), rgb_t(0x59,0x81,0xFF), \
	rgb_t(0x6B,0x92,0xFF), rgb_t(0x7D,0xA2,0xFF), rgb_t(0x8D,0xB1,0xFF), rgb_t(0x9D,0xC0,0xFF), \
	rgb_t(0xAD,0xCF,0xFF), rgb_t(0xBC,0xDE,0xFF), rgb_t(0xCB,0xEC,0xFF), rgb_t(0xDA,0xFA,0xFF   )

#define NTSC_HUE9_PAL_HUE10 \
	rgb_t(0x00,0x00,0x97), rgb_t(0x00,0x20,0xA7), rgb_t(0x00,0x38,0xB6), rgb_t(0x00,0x4C,0xC5), \
	rgb_t(0x00,0x5F,0xD4), rgb_t(0x00,0x71,0xE2), rgb_t(0x0E,0x82,0xF1), rgb_t(0x29,0x93,0xFE), \
	rgb_t(0x3F,0xA3,0xFF), rgb_t(0x53,0xB2,0xFF), rgb_t(0x66,0xC1,0xFF), rgb_t(0x77,0xD0,0xFF), \
	rgb_t(0x88,0xDF,0xFF), rgb_t(0x99,0xED,0xFF), rgb_t(0xA8,0xFB,0xFF), rgb_t(0xB8,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11 \
	rgb_t(0x00,0x1F,0x49), rgb_t(0x00,0x36,0x5C), rgb_t(0x00,0x4B,0x6E), rgb_t(0x00,0x5E,0x7F), \
	rgb_t(0x00,0x70,0x90), rgb_t(0x00,0x81,0xA0), rgb_t(0x00,0x92,0xAF), rgb_t(0x04,0xA2,0xBF), \
	rgb_t(0x23,0xB1,0xCD), rgb_t(0x3A,0xC0,0xDC), rgb_t(0x4E,0xCF,0xEA), rgb_t(0x61,0xDE,0xF8), \
	rgb_t(0x73,0xEC,0xFF), rgb_t(0x84,0xFA,0xFF), rgb_t(0x94,0xFF,0xFF), rgb_t(0xA4,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12 \
	rgb_t(0x00,0x2D,0x00), rgb_t(0x00,0x43,0x00), rgb_t(0x00,0x56,0x00), rgb_t(0x00,0x69,0x16), \
	rgb_t(0x00,0x7A,0x2F), rgb_t(0x00,0x8B,0x44), rgb_t(0x00,0x9B,0x58), rgb_t(0x07,0xAB,0x6A), \
	rgb_t(0x24,0xBA,0x7C), rgb_t(0x3B,0xC9,0x8C), rgb_t(0x50,0xD8,0x9D), rgb_t(0x62,0xE6,0xAC), \
	rgb_t(0x74,0xF4,0xBC), rgb_t(0x85,0xFF,0xCA), rgb_t(0x96,0xFF,0xD9), rgb_t(0xA5,0xFF,0xE7   )

#define NTSC_HUE12_PAL_HUE13 \
	rgb_t(0x00,0x30,0x00), rgb_t(0x00,0x45,0x00), rgb_t(0x00,0x59,0x00), rgb_t(0x00,0x6B,0x00), \
	rgb_t(0x00,0x7C,0x00), rgb_t(0x00,0x8D,0x00), rgb_t(0x14,0x9D,0x00), rgb_t(0x2D,0xAD,0x00), \
	rgb_t(0x43,0xBC,0x1A), rgb_t(0x57,0xCB,0x32), rgb_t(0x69,0xD9,0x48), rgb_t(0x7B,0xE8,0x5B), \
	rgb_t(0x8B,0xF6,0x6D), rgb_t(0x9C,0xFF,0x7E), rgb_t(0xAB,0xFF,0x8F), rgb_t(0xBB,0xFF,0x9F   )

#define NTSC_HUE13_PAL_HUE14 \
	rgb_t(0x00,0x27,0x00), rgb_t(0x00,0x3D,0x00), rgb_t(0x00,0x51,0x00), rgb_t(0x00,0x64,0x00), \
	rgb_t(0x1F,0x76,0x00), rgb_t(0x36,0x87,0x00), rgb_t(0x4B,0x97,0x00), rgb_t(0x5E,0xA7,0x00), \
	rgb_t(0x70,0xB6,0x00), rgb_t(0x81,0xC5,0x00), rgb_t(0x92,0xD4,0x00), rgb_t(0xA2,0xE2,0x0D), \
	rgb_t(0xB1,0xF0,0x28), rgb_t(0xC0,0xFE,0x3E), rgb_t(0xCF,0xFF,0x52), rgb_t(0xDE,0xFF,0x65   )

#define NTSC_HUE14_PAL_HUE15 \
	rgb_t(0x00,0x12,0x00), rgb_t(0x1C,0x2C,0x00), rgb_t(0x34,0x42,0x00), rgb_t(0x49,0x55,0x00), \
	rgb_t(0x5C,0x68,0x00), rgb_t(0x6E,0x79,0x00), rgb_t(0x7F,0x8A,0x00), rgb_t(0x90,0x9A,0x00), \
	rgb_t(0xA0,0xAA,0x00), rgb_t(0xB0,0xB9,0x00), rgb_t(0xBF,0xC8,0x00), rgb_t(0xCE,0xD7,0x00), \
	rgb_t(0xDC,0xE5,0x00), rgb_t(0xEA,0xF3,0x20), rgb_t(0xF8,0xFF,0x37), rgb_t(0xFF,0xFF,0x4C   )

#define NTSC_HUE15 \
	rgb_t(0x45,0x00,0x00), rgb_t(0x58,0x10,0x00), rgb_t(0x6A,0x2B,0x00), rgb_t(0x7C,0x41,0x00), \
	rgb_t(0x8D,0x55,0x00), rgb_t(0x9D,0x67,0x00), rgb_t(0xAC,0x79,0x00), rgb_t(0xBC,0x8A,0x00), \
	rgb_t(0xCB,0x9A,0x00), rgb_t(0xD9,0xAA,0x00), rgb_t(0xE7,0xB9,0x00), rgb_t(0xF5,0xC8,0x03), \
	rgb_t(0xFF,0xD6,0x22), rgb_t(0xFF,0xE5,0x39), rgb_t(0xFF,0xF3,0x4E), rgb_t(0xFF,0xFF,0x61   )
...
/***************************************************************************
    PALETTE - 25.7 PHASE SHIFT - "COOL" via CRT_V2_STD
***************************************************************************/
...
#define NTSC_HUE2_PAL_HUE3_U1 \
	rgb_t(0x5A,0x00,0x00), rgb_t(0x6C,0x00,0x00), rgb_t(0x7D,0x1E,0x00), rgb_t(0x8E,0x36,0x00), \
    	rgb_t(0x9E,0x4B,0x00), rgb_t(0xAE,0x5E,0x00), rgb_t(0xBD,0x70,0x00), rgb_t(0xCC,0x81,0x00), \
    	rgb_t(0xDA,0x92,0x00), rgb_t(0xE9,0xA2,0x00), rgb_t(0xF7,0xB1,0x0E), rgb_t(0xFF,0xC0,0x29), \
    	rgb_t(0xFF,0xCF,0x3F), rgb_t(0xFF,0xDE,0x53), rgb_t(0xFF,0xEC,0x66), rgb_t(0xFF,0xFA,0x77   )

#define NTSC_HUE3_PAL_HUE4_U1 \
	rgb_t(0x76,0x00,0x00), rgb_t(0x87,0x00,0x00), rgb_t(0x97,0x00,0x00), rgb_t(0xA7,0x1F,0x00), \
    	rgb_t(0xB6,0x37,0x00), rgb_t(0xC5,0x4B,0x00), rgb_t(0xD4,0x5F,0x0A), rgb_t(0xE2,0x71,0x26), \
    	rgb_t(0xF0,0x82,0x3D), rgb_t(0xFE,0x92,0x51), rgb_t(0xFF,0xA2,0x63), rgb_t(0xFF,0xB2,0x75), \
    	rgb_t(0xFF,0xC1,0x86), rgb_t(0xFF,0xD0,0x97), rgb_t(0xFF,0xDE,0xA6), rgb_t(0xFF,0xEC,0xB6   )

#define NTSC_HUE4_PAL_HUE5_U1 \
	rgb_t(0x7C,0x00,0x00), rgb_t(0x8D,0x00,0x05), rgb_t(0x9D,0x00,0x23), rgb_t(0xAD,0x0B,0x3A), \
	rgb_t(0xBC,0x27,0x4E), rgb_t(0xCB,0x3D,0x61), rgb_t(0xD9,0x51,0x73), rgb_t(0xE8,0x64,0x84), \
	rgb_t(0xF6,0x76,0x95), rgb_t(0xFF,0x87,0xA5), rgb_t(0xFF,0x97,0xB4), rgb_t(0xFF,0xA7,0xC3), \
	rgb_t(0xFF,0xB6,0xD2), rgb_t(0xFF,0xC5,0xE0), rgb_t(0xFF,0xD4,0xEE), rgb_t(0xFF,0xE2,0xFC   )

#define NTSC_HUE5_PAL_HUE6_U1 \
	rgb_t(0x6D,0x00,0x60), rgb_t(0x7F,0x00,0x72), rgb_t(0x8F,0x00,0x83), rgb_t(0x9F,0x00,0x93), \
	rgb_t(0xAF,0x20,0xA3), rgb_t(0xBE,0x37,0xB3), rgb_t(0xCD,0x4C,0xC2), rgb_t(0xDB,0x5F,0xD1), \
	rgb_t(0xEA,0x71,0xDF), rgb_t(0xF8,0x82,0xED), rgb_t(0xFF,0x92,0xFB), rgb_t(0xFF,0xA2,0xFF), \
	rgb_t(0xFF,0xB2,0xFF), rgb_t(0xFF,0xC1,0xFF), rgb_t(0xFF,0xD0,0xFF), rgb_t(0xFF,0xDE,0xFF   )

#define NTSC_HUE6_PAL_HUE7_U1 \
	rgb_t(0x49,0x00,0xA3), rgb_t(0x5C,0x00,0xB3), rgb_t(0x6E,0x00,0xC2), rgb_t(0x80,0x06,0xD1), \
	rgb_t(0x90,0x24,0xDF), rgb_t(0xA0,0x3B,0xED), rgb_t(0xB0,0x4F,0xFB), rgb_t(0xBF,0x62,0xFF), \
	rgb_t(0xCE,0x74,0xFF), rgb_t(0xDC,0x85,0xFF), rgb_t(0xEA,0x95,0xFF), rgb_t(0xF8,0xA5,0xFF), \
	rgb_t(0xFF,0xB4,0xFF), rgb_t(0xFF,0xC3,0xFF), rgb_t(0xFF,0xD2,0xFF), rgb_t(0xFF,0xE1,0xFF   )

#define NTSC_HUE7_PAL_HUE8_U1 \
	rgb_t(0x08,0x00,0xC6), rgb_t(0x25,0x00,0xD4), rgb_t(0x3C,0x00,0xE3), rgb_t(0x50,0x19,0xF1), \
	rgb_t(0x63,0x32,0xFF), rgb_t(0x75,0x47,0xFF), rgb_t(0x86,0x5A,0xFF), rgb_t(0x96,0x6D,0xFF), \
	rgb_t(0xA6,0x7E,0xFF), rgb_t(0xB5,0x8F,0xFF), rgb_t(0xC4,0x9F,0xFF), rgb_t(0xD3,0xAE,0xFF), \
	rgb_t(0xE1,0xBD,0xFF), rgb_t(0xF0,0xCC,0xFF), rgb_t(0xFD,0xDB,0xFF), rgb_t(0xFF,0xE9,0xFF   )

#define NTSC_HUE8_PAL_HUE9_U1 \
	rgb_t(0x00,0x00,0xC7), rgb_t(0x00,0x00,0xD6), rgb_t(0x00,0x17,0xE4), rgb_t(0x0F,0x30,0xF2), \
	rgb_t(0x2A,0x45,0xFF), rgb_t(0x40,0x59,0xFF), rgb_t(0x54,0x6B,0xFF), rgb_t(0x66,0x7C,0xFF), \
	rgb_t(0x78,0x8D,0xFF), rgb_t(0x89,0x9D,0xFF), rgb_t(0x99,0xAD,0xFF), rgb_t(0xA9,0xBC,0xFF), \
	rgb_t(0xB8,0xCB,0xFF), rgb_t(0xC7,0xDA,0xFF), rgb_t(0xD6,0xE8,0xFF), rgb_t(0xE4,0xF6,0xFF   )

#define NTSC_HUE9_PAL_HUE10_U1 \
	rgb_t(0x00,0x00,0xA8), rgb_t(0x00,0x18,0xB7), rgb_t(0x00,0x31,0xC6), rgb_t(0x00,0x46,0xD5), \
	rgb_t(0x00,0x59,0xE3), rgb_t(0x00,0x6C,0xF1), rgb_t(0x1F,0x7D,0xFF), rgb_t(0x37,0x8E,0xFF), \
	rgb_t(0x4B,0x9E,0xFF), rgb_t(0x5E,0xAD,0xFF), rgb_t(0x70,0xBD,0xFF), rgb_t(0x82,0xCC,0xFF), \
	rgb_t(0x92,0xDA,0xFF), rgb_t(0xA2,0xE8,0xFF), rgb_t(0xB2,0xF6,0xFF), rgb_t(0xC1,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11_U1 \
	rgb_t(0x00,0x17,0x68), rgb_t(0x00,0x30,0x79), rgb_t(0x00,0x45,0x8A), rgb_t(0x00,0x59,0x9A), \
	rgb_t(0x00,0x6B,0xAA), rgb_t(0x00,0x7C,0xB9), rgb_t(0x00,0x8D,0xC8), rgb_t(0x0F,0x9D,0xD7), \
	rgb_t(0x2A,0xAD,0xE5), rgb_t(0x40,0xBC,0xF3), rgb_t(0x54,0xCB,0xFF), rgb_t(0x66,0xDA,0xFF), \
	rgb_t(0x78,0xE8,0xFF), rgb_t(0x89,0xF6,0xFF), rgb_t(0x99,0xFF,0xFF), rgb_t(0xA9,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U1 \
	rgb_t(0x00,0x29,0x00), rgb_t(0x00,0x3F,0x15), rgb_t(0x00,0x53,0x2E), rgb_t(0x00,0x66,0x44), \
	rgb_t(0x00,0x77,0x57), rgb_t(0x00,0x88,0x6A), rgb_t(0x00,0x99,0x7B), rgb_t(0x00,0xA8,0x8C), \
	rgb_t(0x20,0xB8,0x9C), rgb_t(0x37,0xC7,0xAC), rgb_t(0x4C,0xD5,0xBB), rgb_t(0x5F,0xE4,0xCA), \
	rgb_t(0x71,0xF2,0xD9), rgb_t(0x82,0xFF,0xE7), rgb_t(0x93,0xFF,0xF5), rgb_t(0xA3,0xFF,0xFF   )

#define NTSC_HUE12_PAL_HUE13_U1 \
	rgb_t(0x00,0x30,0x00), rgb_t(0x00,0x45,0x00), rgb_t(0x00,0x59,0x00), rgb_t(0x00,0x6B,0x00), \
	rgb_t(0x00,0x7D,0x00), rgb_t(0x00,0x8D,0x00), rgb_t(0x08,0x9D,0x17), rgb_t(0x1C,0xAD,0x30), \
	rgb_t(0x34,0xBC,0x45), rgb_t(0x49,0xCB,0x59), rgb_t(0x5C,0xDA,0x6B), rgb_t(0x6E,0xE8,0x7C), \
	rgb_t(0x80,0xF6,0x8D), rgb_t(0x90,0xFF,0x9D), rgb_t(0xA0,0xFF,0xAD), rgb_t(0xB0,0xFF,0xBC   )

#define NTSC_HUE13_PAL_HUE14_U1 \
	rgb_t(0x00,0x2C,0x00), rgb_t(0x00,0x42,0x00), rgb_t(0x00,0x56,0x00), rgb_t(0x00,0x68,0x00), \
	rgb_t(0x00,0x7A,0x00), rgb_t(0x1A,0x8B,0x00), rgb_t(0x32,0x9B,0x00), rgb_t(0x47,0xAA,0x00), \
	rgb_t(0x5B,0xBA,0x00), rgb_t(0x6D,0xC9,0x00), rgb_t(0x7E,0xD7,0x17), rgb_t(0x8F,0xE6,0x30), \
	rgb_t(0x9F,0xF4,0x45), rgb_t(0xAF,0xFF,0x59), rgb_t(0xBE,0xFF,0x6B), rgb_t(0xCD,0xFF,0x7C   )

#define NTSC_HUE14_PAL_HUE15_U1 \
	rgb_t(0x00,0x1E,0x00), rgb_t(0x00,0x35,0x00), rgb_t(0x0F,0x4A,0x00), rgb_t(0x2A,0x5D,0x00), \
	rgb_t(0x40,0x6F,0x00), rgb_t(0x54,0x81,0x00), rgb_t(0x66,0x91,0x00), rgb_t(0x78,0xA1,0x00), \
	rgb_t(0x89,0xB1,0x00), rgb_t(0x99,0xC0,0x00), rgb_t(0xA9,0xCF,0x00), rgb_t(0xB8,0xDD,0x00), \
	rgb_t(0xC7,0xEB,0x0E), rgb_t(0xD6,0xF9,0x29), rgb_t(0xE4,0xFF,0x3F), rgb_t(0xF2,0xFF,0x53   )

#define NTSC_HUE15_U1 \
	rgb_t(0x25,0x00,0x00), rgb_t(0x3C,0x20,0x00), rgb_t(0x50,0x37,0x00), rgb_t(0x63,0x4C,0x00), \
	rgb_t(0x75,0x5F,0x00), rgb_t(0x86,0x71,0x00), rgb_t(0x96,0x82,0x00), rgb_t(0xA6,0x93,0x00), \
	rgb_t(0xB5,0xA3,0x00), rgb_t(0xC4,0xB2,0x00), rgb_t(0xD3,0xC1,0x00), rgb_t(0xE2,0xD0,0x00), \
	rgb_t(0xF0,0xDF,0x09), rgb_t(0xFE,0xED,0x26), rgb_t(0xFF,0xFB,0x3C), rgb_t(0xFF,0xFF,0x50   )
...
/***************************************************************************
    PALETTE - 27.7 PHASE SHIFT - "HOT" via CRT_V2_STD
***************************************************************************/
...
#define NTSC_HUE2_PAL_HUE3_U2 \
	rgb_t(0x5D,0x00,0x00), rgb_t(0x6F,0x00,0x00), rgb_t(0x80,0x1C,0x00), rgb_t(0x91,0x34,0x00), \
    	rgb_t(0xA1,0x49,0x00), rgb_t(0xB0,0x5C,0x00), rgb_t(0xBF,0x6F,0x00), rgb_t(0xCE,0x80,0x00), \
    	rgb_t(0xDD,0x90,0x00), rgb_t(0xEB,0xA0,0x00), rgb_t(0xF9,0xB0,0x15), rgb_t(0xFF,0xBF,0x2F), \
    	rgb_t(0xFF,0xCE,0x44), rgb_t(0xFF,0xDC,0x58), rgb_t(0xFF,0xEB,0x6A), rgb_t(0xFF,0xF9,0x7C   )

#define NTSC_HUE3_PAL_HUE4_U2 \
	rgb_t(0x78,0x00,0x00), rgb_t(0x89,0x00,0x00), rgb_t(0x99,0x00,0x00), rgb_t(0xA9,0x1C,0x00), \
    	rgb_t(0xB8,0x34,0x00), rgb_t(0xC7,0x49,0x00), rgb_t(0xD6,0x5C,0x1F), rgb_t(0xE4,0x6E,0x36), \
    	rgb_t(0xF2,0x80,0x4B), rgb_t(0xFF,0x90,0x5E), rgb_t(0xFF,0xA0,0x70), rgb_t(0xFF,0xB0,0x82), \
    	rgb_t(0xFF,0xBF,0x92), rgb_t(0xFF,0xCE,0xA2), rgb_t(0xFF,0xDC,0xB2), rgb_t(0xFF,0xEA,0xC1   )

#define NTSC_HUE4_PAL_HUE5_U2 \
	rgb_t(0x7B,0x00,0x0C), rgb_t(0x8B,0x00,0x28), rgb_t(0x9C,0x00,0x3E), rgb_t(0xAB,0x07,0x52), \
	rgb_t(0xBB,0x24,0x65), rgb_t(0xCA,0x3B,0x76), rgb_t(0xD8,0x4F,0x87), rgb_t(0xE6,0x62,0x98), \
	rgb_t(0xF4,0x74,0xA7), rgb_t(0xFF,0x85,0xB7), rgb_t(0xFF,0x95,0xC6), rgb_t(0xFF,0xA5,0xD4), \
	rgb_t(0xFF,0xB5,0xE3), rgb_t(0xFF,0xC4,0xF1), rgb_t(0xFF,0xD2,0xFF), rgb_t(0xFF,0xE1,0xFF   )

#define NTSC_HUE5_PAL_HUE6_U2 \
	rgb_t(0x64,0x00,0x79), rgb_t(0x76,0x00,0x89), rgb_t(0x87,0x00,0x9A), rgb_t(0x97,0x00,0xA9), \
	rgb_t(0xA7,0x20,0xB9), rgb_t(0xB6,0x37,0xC8), rgb_t(0xC5,0x4C,0xD6), rgb_t(0xD4,0x5F,0xE5), \
	rgb_t(0xE2,0x71,0xF3), rgb_t(0xF1,0x82,0xFF), rgb_t(0xFE,0x92,0xFF), rgb_t(0xFF,0xA2,0xFF), \
	rgb_t(0xFF,0xB2,0xFF), rgb_t(0xFF,0xC1,0xFF), rgb_t(0xFF,0xD0,0xFF), rgb_t(0xFF,0xDE,0xFF   )

#define NTSC_HUE6_PAL_HUE7_U2 \
	rgb_t(0x35,0x00,0xB5), rgb_t(0x4A,0x00,0xC4), rgb_t(0x5D,0x00,0xD2), rgb_t(0x6F,0x0D,0xE1), \
	rgb_t(0x80,0x28,0xEF), rgb_t(0x91,0x3F,0xFD), rgb_t(0xA1,0x53,0xFF), rgb_t(0xB0,0x65,0xFF), \
	rgb_t(0xBF,0x77,0xFF), rgb_t(0xCE,0x88,0xFF), rgb_t(0xDD,0x98,0xFF), rgb_t(0xEB,0xA8,0xFF), \
	rgb_t(0xF9,0xB7,0xFF), rgb_t(0xFF,0xC6,0xFF), rgb_t(0xFF,0xD5,0xFF), rgb_t(0xFF,0xE3,0xFF   )

#define NTSC_HUE7_PAL_HUE8_U2 \
	rgb_t(0x00,0x00,0xCB), rgb_t(0x00,0x00,0xD9), rgb_t(0x1D,0x06,0xE8), rgb_t(0x35,0x24,0xF6), \
	rgb_t(0x4A,0x3A,0xFF), rgb_t(0x5D,0x4F,0xFF), rgb_t(0x6F,0x62,0xFF), rgb_t(0x80,0x74,0xFF), \
	rgb_t(0x91,0x85,0xFF), rgb_t(0xA1,0x95,0xFF), rgb_t(0xB0,0xA5,0xFF), rgb_t(0xBF,0xB4,0xFF), \
	rgb_t(0xCE,0xC3,0xFF), rgb_t(0xDD,0xD2,0xFF), rgb_t(0xEB,0xE1,0xFF), rgb_t(0xF9,0xEF,0xFF   )

#define NTSC_HUE8_PAL_HUE9_U2 \
	rgb_t(0x00,0x00,0xBA), rgb_t(0x00,0x00,0xC9), rgb_t(0x00,0x26,0xD8), rgb_t(0x00,0x3C,0xE6), \
	rgb_t(0x00,0x50,0xF4), rgb_t(0x20,0x63,0xFF), rgb_t(0x37,0x75,0xFF), rgb_t(0x4C,0x86,0xFF), \
	rgb_t(0x5F,0x96,0xFF), rgb_t(0x71,0xA6,0xFF), rgb_t(0x82,0xB6,0xFF), rgb_t(0x93,0xC5,0xFF), \
	rgb_t(0xA2,0xD3,0xFF), rgb_t(0xB2,0xE2,0xFF), rgb_t(0xC1,0xF0,0xFF), rgb_t(0xD0,0xFE,0xFF   )

#define NTSC_HUE9_PAL_HUE10_U2 \
	rgb_t(0x00,0x0C,0x84), rgb_t(0x00,0x28,0x94), rgb_t(0x00,0x3E,0xA4), rgb_t(0x00,0x52,0xB3), \
	rgb_t(0x00,0x65,0xC3), rgb_t(0x00,0x77,0xD1), rgb_t(0x00,0x88,0xE0), rgb_t(0x1C,0x98,0xEE), \
	rgb_t(0X34,0xA8,0xFC), rgb_t(0x49,0xB7,0xFF), rgb_t(0x5D,0xC6,0xFF), rgb_t(0x6F,0xD5,0xFF), \
	rgb_t(0x80,0xE3,0xFF), rgb_t(0x90,0xF1,0xFF), rgb_t(0xA0,0xFF,0xFF), rgb_t(0xB0,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11_U2 \
	rgb_t(0x00,0x25,0x22), rgb_t(0x00,0x3C,0x39), rgb_t(0x00,0x50,0x4E), rgb_t(0x00,0x63,0x61), \
	rgb_t(0x00,0x74,0x73), rgb_t(0x00,0x85,0x84), rgb_t(0x00,0x96,0x94), rgb_t(0x00,0xA6,0xA4), \
	rgb_t(0x20,0xB5,0xB4), rgb_t(0x37,0xC4,0xC3), rgb_t(0x4C,0xD3,0xD1), rgb_t(0x5F,0xE1,0xE0), \
	rgb_t(0x71,0xEF,0xEE), rgb_t(0x82,0xFD,0xFC), rgb_t(0x92,0xFF,0xFF), rgb_t(0xA2,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U2 \
	rgb_t(0x00,0x2F,0x00), rgb_t(0x00,0x45,0x00), rgb_t(0x00,0x58,0x00), rgb_t(0x00,0x6B,0x00), \
	rgb_t(0x00,0x7C,0x00), rgb_t(0x00,0x8D,0x18), rgb_t(0x00,0x9D,0x31), rgb_t(0x14,0xAD,0x46), \
	rgb_t(0x2D,0xBC,0x5A), rgb_t(0x43,0xCB,0x6C), rgb_t(0x57,0xD9,0x7D), rgb_t(0x69,0xE8,0x8E), \
	rgb_t(0x7B,0xF6,0x9E), rgb_t(0x8B,0xFF,0xAE), rgb_t(0x9C,0xFF,0xBD), rgb_t(0xAB,0xFF,0xCC   )

#define NTSC_HUE12_PAL_HUE13_U2 \
	rgb_t(0x00,0x2D,0x00), rgb_t(0x00,0x43,0x00), rgb_t(0x00,0x57,0x00), rgb_t(0x00,0x69,0x00), \
	rgb_t(0x00,0x7B,0x00), rgb_t(0x10,0x8B,0x00), rgb_t(0x2B,0x9C,0x00), rgb_t(0x41,0xAB,0x00), \
	rgb_t(0x55,0xBB,0x00), rgb_t(0x67,0xC9,0x06), rgb_t(0x79,0xD8,0x23), rgb_t(0x8A,0xE6,0x3A), \
	rgb_t(0x9A,0xF4,0x4F), rgb_t(0xAA,0xFF,0x62), rgb_t(0xB9,0xFF,0x73), rgb_t(0xC8,0xFF,0x84   )
...
#define NTSC_HUE14_PAL_HUE15_U2 \
	rgb_t(0x26,0x00,0x00), rgb_t(0x3D,0x20,0x00), rgb_t(0x51,0x37,0x00), rgb_t(0x64,0x4C,0x00), \
	rgb_t(0x75,0x5F,0x00), rgb_t(0x86,0x71,0x00), rgb_t(0x97,0x82,0x00), rgb_t(0xA7,0x93,0x00), \
	rgb_t(0xB6,0xA3,0x00), rgb_t(0xC5,0xB2,0x00), rgb_t(0xD4,0xC1,0x00), rgb_t(0xE2,0xD0,0x00), \
	rgb_t(0xF0,0xDE,0x09), rgb_t(0xFE,0xED,0x26), rgb_t(0xFF,0xFA,0x3C), rgb_t(0xFF,0xFF,0x51   )

#define  NTSC_HUE15_U2 \
	rgb_t(0x5C,0x00,0x00), rgb_t(0x6E,0x00,0x00), rgb_t(0x80,0x1D,0x00), rgb_t(0x90,0x35,0x00), \
	rgb_t(0xA0,0x49,0x00), rgb_t(0xB0,0x5D,0x00), rgb_t(0xBF,0x6F,0x00), rgb_t(0xCE,0x80,0x00), \
	rgb_t(0xDC,0x91,0x00), rgb_t(0xEA,0xA1,0x00), rgb_t(0xF8,0xB0,0x14), rgb_t(0xFF,0xBF,0x2E), \
	rgb_t(0xFF,0xCE,0x43), rgb_t(0xFF,0xDD,0x57), rgb_t(0xFF,0xEB,0x69), rgb_t(0xFF,0xF9,0x7B   )
...
void a7800_state::machine_start()
{
	...
	if (m_cart->exists())
	{
		switch (m_cart->get_cart_type())
		{
			...
			case A78_BANKSET_SG_POK450:
			case A78_BANKSET_SG_BANKRAM_POK450:
			case A78_BANKSET_BANKRAM_POK450:

...
/***************************************************************************
    26.7 PHASE SHIFT - NTSC_CRT_BAL_WARM from TREBORS PRO PALETTES V2
***************************************************************************/
...
#define PAL_HUE1 \
	...
	rgb_t(0x55,0x62,0x00), rgb_t(0x67,0x73,0x00), rgb_t(0x78,0x84,0x00), rgb_t(0x89,0x95,0x00), \
	rgb_t(0x99,0xA5,0x12), rgb_t(0xA9,0xB5,0x29), rgb_t(0xB9,0xC5,0x3D), rgb_t(0xC9,0xD4,0x50), \
	rgb_t(0xD8,0xE3,0x62), rgb_t(0xE7,0xF2,0x74), rgb_t(0xF6,0xFF,0x85), rgb_t(0xFF,0xFF,0x95   )
...
#define NTSC_HUE4_PAL_HUE5 \
	...
	rgb_t(0x91,0x20,0x36), rgb_t(0xA1,0x35,0x49), rgb_t(0xB1,0x49,0x5C), rgb_t(0xC1,0x5B,0x6D), \
	rgb_t(0xD0,0x6D,0x7F), rgb_t(0xDF,0x7E,0x8F), rgb_t(0xEE,0x8F,0xA0), rgb_t(0xFD,0x9F,0xB0), \
	rgb_t(0xFF,0xAF,0xBF), rgb_t(0xFF,0xBF,0xCF), rgb_t(0xFF,0xCF,0xDE), rgb_t(0xFF,0xDE,0xED   )

#define NTSC_HUE5_PAL_HUE6 \
	rgb_t(0x3D,0x00,0x26), rgb_t(0x50,0x00,0x3B), rgb_t(0x62,0x00,0x4E), rgb_t(0x74,0x00,0x60), \
	rgb_t(0x85,0x1C,0x72), rgb_t(0x95,0x31,0x83), rgb_t(0xA5,0x45,0x93), rgb_t(0xB5,0x58,0xA4), \
	rgb_t(0xC5,0x69,0xB4), rgb_t(0xD4,0x7B,0xC3), rgb_t(0xE4,0x8C,0xD3), rgb_t(0xF2,0x9C,0xE2), \
	rgb_t(0xFF,0xAC,0xF1), rgb_t(0xFF,0xBC,0xFF), rgb_t(0xFF,0xCB,0xFF), rgb_t(0xFF,0xDB,0xFF   )

#define NTSC_HUE6_PAL_HUE7 \
	rgb_t(0x20,0x00,0x5D), rgb_t(0x35,0x00,0x6E), rgb_t(0x48,0x00,0x80), rgb_t(0x5B,0x0A,0x90), \
	rgb_t(0x6D,0x22,0xA1), rgb_t(0x7E,0x37,0xB1), rgb_t(0x8E,0x4B,0xC0), rgb_t(0x9F,0x5D,0xD0), \
	rgb_t(0xAF,0x6F,0xDF), rgb_t(0xBF,0x80,0xEE), rgb_t(0xCE,0x91,0xFD), rgb_t(0xDD,0xA1,0xFF), \
	rgb_t(0xEC,0xB1,0xFF), rgb_t(0xFB,0xC1,0xFF), rgb_t(0xFF,0xD0,0xFF), rgb_t(0xFF,0xDF,0xFF   )

#define NTSC_HUE7_PAL_HUE8 \
	rgb_t(0x00,0x00,0x7C), rgb_t(0x0D,0x00,0x8C), rgb_t(0x24,0x03,0x9D), rgb_t(0x39,0x1D,0xAD), \
	rgb_t(0x4C,0x33,0xBD), rgb_t(0x5F,0x46,0xCC), rgb_t(0x70,0x59,0xDC), rgb_t(0x81,0x6B,0xEB), \
	rgb_t(0x92,0x7C,0xF9), rgb_t(0xA2,0x8D,0xFF), rgb_t(0xB2,0x9D,0xFF), rgb_t(0xC2,0xAD,0xFF), \
	rgb_t(0xD2,0xBD,0xFF), rgb_t(0xE1,0xCD,0xFF), rgb_t(0xF0,0xDC,0xFF), rgb_t(0xFF,0xEB,0xFF   )

#define NTSC_HUE8_PAL_HUE9 \
	rgb_t(0x00,0x00,0x82), rgb_t(0x00,0x05,0x92), rgb_t(0x00,0x1E,0xA3), rgb_t(0x13,0x34,0xB3), \
	rgb_t(0x29,0x47,0xC2), rgb_t(0x3E,0x5A,0xD2), rgb_t(0x51,0x6C,0xE1), rgb_t(0x63,0x7D,0xF0), \
	rgb_t(0x74,0x8E,0xFF), rgb_t(0x85,0x9E,0xFF), rgb_t(0x96,0xAE,0xFF), rgb_t(0xA6,0xBE,0xFF), \
	rgb_t(0xB6,0xCD,0xFF), rgb_t(0xC6,0xDD,0xFF), rgb_t(0xD5,0xEC,0xFF), rgb_t(0xE4,0xFB,0xFF   )

#define NTSC_HUE9_PAL_HUE10 \
	rgb_t(0x00,0x08,0x6E), rgb_t(0x00,0x21,0x7F), rgb_t(0x00,0x36,0x90), rgb_t(0x00,0x49,0xA0), \
	rgb_t(0x08,0x5C,0xB0), rgb_t(0x21,0x6E,0xC0), rgb_t(0x36,0x7F,0xD0), rgb_t(0x49,0x90,0xDF), \
	rgb_t(0x5C,0xA0,0xEE), rgb_t(0x6E,0xB0,0xFD), rgb_t(0x7F,0xC0,0xFF), rgb_t(0x90,0xCF,0xFF), \
	rgb_t(0xA0,0xDE,0xFF), rgb_t(0xB0,0xED,0xFF), rgb_t(0xC0,0xFC,0xFF), rgb_t(0xCF,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11 \
	rgb_t(0x00,0x20,0x43), rgb_t(0x00,0x35,0x55), rgb_t(0x00,0x48,0x67), rgb_t(0x00,0x5B,0x79), \
	rgb_t(0x00,0x6D,0x8A), rgb_t(0x10,0x7E,0x9A), rgb_t(0x27,0x8F,0xAA), rgb_t(0x3C,0x9F,0xBA), \
	rgb_t(0x4F,0xAF,0xCA), rgb_t(0x61,0xBF,0xD9), rgb_t(0x73,0xCE,0xE8), rgb_t(0x84,0xDE,0xF7), \
	rgb_t(0x94,0xED,0xFF), rgb_t(0xA5,0xFB,0xFF), rgb_t(0xB5,0xFF,0xFF), rgb_t(0xC4,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12 \
	rgb_t(0x00,0x2C,0x00), rgb_t(0x00,0x40,0x16), rgb_t(0x00,0x53,0x2C), rgb_t(0x00,0x65,0x40), \
	rgb_t(0x00,0x76,0x53), rgb_t(0x13,0x87,0x65), rgb_t(0x2A,0x98,0x77), rgb_t(0x3E,0xA8,0x87), \
	rgb_t(0x51,0xB8,0x98), rgb_t(0x63,0xC8,0xA8), rgb_t(0x75,0xD7,0xB8), rgb_t(0x86,0xE6,0xC8), \
	rgb_t(0x96,0xF5,0xD7), rgb_t(0xA7,0xFF,0xE6), rgb_t(0xB7,0xFF,0xF5), rgb_t(0xC6,0xFF,0xFF   )

#define NTSC_HUE12_PAL_HUE13 \
	rgb_t(0x00,0x2D,0x00), rgb_t(0x00,0x41,0x00), rgb_t(0x00,0x54,0x00), rgb_t(0x00,0x66,0x00), \
	rgb_t(0x12,0x78,0x11), rgb_t(0x29,0x89,0x28), rgb_t(0x3D,0x99,0x3C), rgb_t(0x50,0xA9,0x4F), \
	rgb_t(0x62,0xB9,0x62), rgb_t(0x74,0xC9,0x73), rgb_t(0x85,0xD8,0x84), rgb_t(0x95,0xE7,0x95), \
	rgb_t(0xA6,0xF6,0xA5), rgb_t(0xB5,0xFF,0xB5), rgb_t(0xC5,0xFF,0xC5), rgb_t(0xD4,0xFF,0xD4   )

#define NTSC_HUE13_PAL_HUE14 \
	rgb_t(0x00,0x24,0x00), rgb_t(0x00,0x39,0x00), rgb_t(0x05,0x4C,0x00), rgb_t(0x1E,0x5E,0x00), \
	rgb_t(0x34,0x70,0x00), rgb_t(0x47,0x81,0x00), rgb_t(0x5A,0x92,0x00), rgb_t(0x6C,0xA2,0x1B), \
	rgb_t(0x7D,0xB2,0x31), rgb_t(0x8E,0xC2,0x44), rgb_t(0x9E,0xD1,0x57), rgb_t(0xAE,0xE0,0x69), \
	rgb_t(0xBE,0xEF,0x7A), rgb_t(0xCD,0xFE,0x8B), rgb_t(0xDD,0xFF,0x9C), rgb_t(0xEC,0xFF,0xAC   )

#define NTSC_HUE14_PAL_HUE15 \
	rgb_t(0x00,0x10,0x00), rgb_t(0x1A,0x27,0x00), rgb_t(0x30,0x3B,0x00), rgb_t(0x44,0x4F,0x00), \
	rgb_t(0x56,0x61,0x00), rgb_t(0x68,0x72,0x00), rgb_t(0x7A,0x83,0x00), rgb_t(0x8B,0x94,0x00), \
	rgb_t(0x9B,0xA4,0x11), rgb_t(0xAB,0xB4,0x28), rgb_t(0xBB,0xC4,0x3C), rgb_t(0xCB,0xD3,0x4F), \
	rgb_t(0xDA,0xE3,0x62), rgb_t(0xE9,0xF2,0x73), rgb_t(0xF8,0xFF,0x84), rgb_t(0xFF,0xFF,0x95   )

#define NTSC_HUE15 \
	rgb_t(0x2A,0x00,0x00), rgb_t(0x3E,0x0D,0x00), rgb_t(0x51,0x25,0x00), rgb_t(0x63,0x3A,0x00), \
	rgb_t(0x75,0x4D,0x00), rgb_t(0x86,0x5F,0x00), rgb_t(0x96,0x71,0x00), rgb_t(0xA6,0x82,0x00), \
	rgb_t(0xB6,0x93,0x12), rgb_t(0xC6,0xA3,0x29), rgb_t(0xD5,0xB3,0x3D), rgb_t(0xE5,0xC2,0x50), \
	rgb_t(0xF3,0xD2,0x62), rgb_t(0xFF,0xE1,0x74), rgb_t(0xFF,0xF0,0x85), rgb_t(0xFF,0xFF,0x96   )
...
/***************************************************************************
    25.7 PHASE SHIFT - NTSC_CRT_BAL_COOL from TREBORS PRO PALETTES V2
***************************************************************************/
...
#define NTSC_HUE4_PAL_HUE5_U1 \
	...
	rgb_t(0x91,0x21,0x2E), rgb_t(0xA2,0x36,0x42), rgb_t(0xB2,0x4A,0x55), rgb_t(0xC1,0x5C,0x67), \
	rgb_t(0xD1,0x6E,0x78), rgb_t(0xE0,0x7F,0x89), rgb_t(0xEF,0x90,0x99), rgb_t(0xFE,0xA0,0xAA), \
	rgb_t(0xFF,0xB0,0xB9), rgb_t(0xFF,0xC0,0xC9), rgb_t(0xFF,0xCF,0xD8), rgb_t(0xFF,0xDF,0xE7   )

#define NTSC_HUE5_PAL_HUE6_U1 \
	rgb_t(0x40,0x00,0x1B), rgb_t(0x53,0x00,0x30), rgb_t(0x65,0x00,0x44), rgb_t(0x76,0x00,0x57), \
	rgb_t(0x87,0x1B,0x69), rgb_t(0x98,0x31,0x7A), rgb_t(0xA8,0x45,0x8B), rgb_t(0xB8,0x57,0x9B), \
	rgb_t(0xC8,0x69,0xAC), rgb_t(0xD7,0x7B,0xBB), rgb_t(0xE6,0x8C,0xCB), rgb_t(0xF5,0x9C,0xDA), \
	rgb_t(0xFF,0xAC,0xE9), rgb_t(0xFF,0xBC,0xF8), rgb_t(0xFF,0xCB,0xFF), rgb_t(0xFF,0xDB,0xFF   )

#define NTSC_HUE6_PAL_HUE7_U1 \
	rgb_t(0x27,0x00,0x54), rgb_t(0x3B,0x00,0x66), rgb_t(0x4E,0x00,0x77), rgb_t(0x61,0x07,0x88), \
	rgb_t(0x72,0x20,0x99), rgb_t(0x83,0x35,0xA9), rgb_t(0x94,0x49,0xB9), rgb_t(0xA4,0x5B,0xC8), \
	rgb_t(0xB4,0x6D,0xD7), rgb_t(0xC4,0x7E,0xE7), rgb_t(0xD3,0x8F,0xF6), rgb_t(0xE2,0x9F,0xFF), \
	rgb_t(0xF1,0xAF,0xFF), rgb_t(0xFF,0xBF,0xFF), rgb_t(0xFF,0xCF,0xFF), rgb_t(0xFF,0xDE,0xFF   )

#define NTSC_HUE7_PAL_HUE8_U1 \
	rgb_t(0x00,0x00,0x76), rgb_t(0x18,0x00,0x87), rgb_t(0x2E,0x00,0x98), rgb_t(0x42,0x18,0xA8), \
	rgb_t(0x55,0x2E,0xB8), rgb_t(0x67,0x42,0xC8), rgb_t(0x78,0x55,0xD7), rgb_t(0x89,0x67,0xE6), \
	rgb_t(0x99,0x78,0xF5), rgb_t(0xAA,0x89,0xFF), rgb_t(0xB9,0x9A,0xFF), rgb_t(0xC9,0xAA,0xFF), \
	rgb_t(0xD8,0xBA,0xFF), rgb_t(0xE7,0xC9,0xFF), rgb_t(0xF6,0xD9,0xFF), rgb_t(0xFF,0xE8,0xFF   )

#define NTSC_HUE8_PAL_HUE9_U1 \
	rgb_t(0x00,0x00,0x83), rgb_t(0x00,0x00,0x93), rgb_t(0x04,0x17,0xA3), rgb_t(0x1E,0x2D,0xB3), \
	rgb_t(0x33,0x41,0xC3), rgb_t(0x47,0x54,0xD2), rgb_t(0x59,0x66,0xE2), rgb_t(0x6B,0x78,0xF1), \
	rgb_t(0x7C,0x89,0xFF), rgb_t(0x8D,0x99,0xFF), rgb_t(0x9E,0xA9,0xFF), rgb_t(0xAE,0xB9,0xFF), \
	rgb_t(0xBD,0xC9,0xFF), rgb_t(0xCD,0xD8,0xFF), rgb_t(0xDC,0xE7,0xFF), rgb_t(0xEB,0xF6,0xFF   )

#define NTSC_HUE9_PAL_HUE10_U1 \
	rgb_t(0x00,0x00,0x77), rgb_t(0x00,0x19,0x88), rgb_t(0x00,0x2F,0x98), rgb_t(0x00,0x43,0xA9), \
	rgb_t(0x12,0x56,0xB8), rgb_t(0x29,0x68,0xC8), rgb_t(0x3D,0x79,0xD7), rgb_t(0x51,0x8A,0xE7), \
	rgb_t(0x63,0x9A,0xF6), rgb_t(0x74,0xAA,0xFF), rgb_t(0x85,0xBA,0xFF), rgb_t(0x96,0xCA,0xFF), \
	rgb_t(0xA6,0xD9,0xFF), rgb_t(0xB6,0xE8,0xFF), rgb_t(0xC6,0xF7,0xFF), rgb_t(0xD5,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11_U1 \
	rgb_t(0x00,0x19,0x55), rgb_t(0x00,0x2F,0x67), rgb_t(0x00,0x43,0x78), rgb_t(0x00,0x55,0x89), \
	rgb_t(0x00,0x67,0x9A), rgb_t(0x14,0x79,0xAA), rgb_t(0x2B,0x8A,0xBA), rgb_t(0x3F,0x9A,0xC9), \
	rgb_t(0x52,0xAA,0xD8), rgb_t(0x64,0xBA,0xE8), rgb_t(0x76,0xCA,0xF7), rgb_t(0x86,0xD9,0xFF), \
	rgb_t(0x97,0xE8,0xFF), rgb_t(0xA7,0xF7,0xFF), rgb_t(0xB7,0xFF,0xFF), rgb_t(0xC7,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U1 \
	rgb_t(0x00,0x28,0x1D), rgb_t(0x00,0x3D,0x32), rgb_t(0x00,0x50,0x46), rgb_t(0x00,0x62,0x58), \
	rgb_t(0x00,0x74,0x6A), rgb_t(0x10,0x85,0x7C), rgb_t(0x27,0x95,0x8C), rgb_t(0x3B,0xA5,0x9D), \
	rgb_t(0x4E,0xB5,0xAD), rgb_t(0x61,0xC5,0xBD), rgb_t(0x72,0xD4,0xCC), rgb_t(0x83,0xE4,0xDB), \
	rgb_t(0x94,0xF2,0xEB), rgb_t(0xA4,0xFF,0xF9), rgb_t(0xB4,0xFF,0xFF), rgb_t(0xC4,0xFF,0xFF   )

#define NTSC_HUE12_PAL_HUE13_U1 \
	rgb_t(0x00,0x2E,0x00), rgb_t(0x00,0x42,0x00), rgb_t(0x00,0x55,0x00), rgb_t(0x00,0x67,0x1A), \
	rgb_t(0x04,0x78,0x30), rgb_t(0x1E,0x89,0x43), rgb_t(0x33,0x9A,0x56), rgb_t(0x47,0xAA,0x68), \
	rgb_t(0x59,0xBA,0x79), rgb_t(0x6B,0xC9,0x8A), rgb_t(0x7C,0xD9,0x9B), rgb_t(0x8D,0xE8,0xAB), \
	rgb_t(0x9D,0xF7,0xBB), rgb_t(0xAE,0xFF,0xCA), rgb_t(0xBD,0xFF,0xDA), rgb_t(0xCD,0xFF,0xE9   )

#define NTSC_HUE13_PAL_HUE14_U1 \
	rgb_t(0x00,0x2A,0x00), rgb_t(0x00,0x3E,0x00), rgb_t(0x00,0x51,0x00), rgb_t(0x0B,0x63,0x00), \
	rgb_t(0x23,0x75,0x00), rgb_t(0x38,0x86,0x04), rgb_t(0x4B,0x96,0x1E), rgb_t(0x5E,0xA6,0x33), \
	rgb_t(0x6F,0xB6,0x47), rgb_t(0x80,0xC6,0x59), rgb_t(0x91,0xD5,0x6B), rgb_t(0xA1,0xE5,0x7C), \
	rgb_t(0xB1,0xF3,0x8D), rgb_t(0xC1,0xFF,0x9E), rgb_t(0xD1,0xFF,0xAE), rgb_t(0xE0,0xFF,0xBD   )

#define NTSC_HUE14_PAL_HUE15_U1 \
	rgb_t(0x00,0x1C,0x00), rgb_t(0x00,0x31,0x00), rgb_t(0x1B,0x45,0x00), rgb_t(0x31,0x58,0x00), \
	rgb_t(0x45,0x6A,0x00), rgb_t(0x57,0x7B,0x00), rgb_t(0x69,0x8C,0x00), rgb_t(0x7B,0x9C,0x05), \
	rgb_t(0x8B,0xAC,0x1E), rgb_t(0x9C,0xBC,0x34), rgb_t(0xAC,0xCB,0x47), rgb_t(0xBC,0xDB,0x5A), \
	rgb_t(0xCB,0xEA,0x6C), rgb_t(0xDB,0xF9,0x7D), rgb_t(0xEA,0xFF,0x8E), rgb_t(0xF9,0xFF,0x9E   )

#define NTSC_HUE15_U1 \
	rgb_t(0x15,0x02,0x00), rgb_t(0x2C,0x1D,0x00), rgb_t(0x40,0x32,0x00), rgb_t(0x53,0x46,0x00), \
	rgb_t(0x65,0x58,0x00), rgb_t(0x76,0x6A,0x00), rgb_t(0x87,0x7C,0x00), rgb_t(0x98,0x8C,0x00), \
	rgb_t(0xA8,0x9D,0x0D), rgb_t(0xB8,0xAD,0x24), rgb_t(0xC7,0xBD,0x39), rgb_t(0xD7,0xCC,0x4C), \
	rgb_t(0xE6,0xDB,0x5F), rgb_t(0xF5,0xEB,0x70), rgb_t(0xFF,0xF9,0x81), rgb_t(0xFF,0xFF,0x92   )
...
/***************************************************************************
    27.7 PHASE SHIFT - NTSC_CRT_BAL_HOT from TREBORS PRO PALETTES V2
***************************************************************************/
...
#define NTSC_HUE2_PAL_HUE3_U2 \
	rgb_t(0x38,0x00,0x00), rgb_t(0x4B,0x00,0x00), rgb_t(0x5E,0x18,0x00), rgb_t(0x6F,0x2E,0x00), \
   	rgb_t(0x81,0x42,0x00), rgb_t(0x91,0x55,0x00), rgb_t(0xA2,0x67,0x00), rgb_t(0xB2,0x78,0x07), \
   	rgb_t(0xC1,0x89,0x20), rgb_t(0xD1,0x9A,0x35), rgb_t(0xE0,0xAA,0x49), rgb_t(0xEF,0xBA,0x5B), \
   	rgb_t(0xFE,0xC9,0x6D), rgb_t(0xFF,0xD9,0x7E), rgb_t(0xFF,0xE8,0x8F), rgb_t(0xFF,0xF7,0x9F   )

#define NTSC_HUE3_PAL_HUE4_U2 \
	rgb_t(0x4A,0x00,0x00), rgb_t(0x5C,0x00,0x00), rgb_t(0x6E,0x00,0x00), rgb_t(0x7F,0x17,0x00), \
   	rgb_t(0x90,0x2D,0x00), rgb_t(0xA0,0x41,0x0E), rgb_t(0xB0,0x54,0x25), rgb_t(0xC0,0x66,0x3A), \
   	rgb_t(0xCF,0x78,0x4D), rgb_t(0xDE,0x89,0x5F), rgb_t(0xED,0x99,0x71), rgb_t(0xFC,0xA9,0x82), \
   	rgb_t(0xFF,0xB9,0x93), rgb_t(0xFF,0xC9,0xA3), rgb_t(0xFF,0xD8,0xB3), rgb_t(0xFF,0xE7,0xC3   )

#define NTSC_HUE4_PAL_HUE5_U2 \
	rgb_t(0x4A,0x00,0x00), rgb_t(0x5C,0x00,0x00), rgb_t(0x6E,0x00,0x12), rgb_t(0x7F,0x06,0x29), \
	rgb_t(0x90,0x1F,0x3D), rgb_t(0xA0,0x34,0x50), rgb_t(0xB0,0x48,0x62), rgb_t(0xC0,0x5A,0x74), \
	rgb_t(0xD0,0x6C,0x85), rgb_t(0xDF,0x7D,0x95), rgb_t(0xEE,0x8E,0xA6), rgb_t(0xFD,0x9F,0xB5), \
	rgb_t(0xFF,0xAF,0xC5), rgb_t(0xFF,0xBE,0xD5), rgb_t(0xFF,0xCE,0xE4), rgb_t(0xFF,0xDD,0xF3   )

#define NTSC_HUE5_PAL_HUE6_U2 \
	rgb_t(0x39,0x00,0x30), rgb_t(0x4D,0x00,0x44), rgb_t(0x5F,0x00,0x56), rgb_t(0x71,0x01,0x68), \
	rgb_t(0x82,0x1C,0x7A), rgb_t(0x92,0x31,0x8B), rgb_t(0xA3,0x45,0x9B), rgb_t(0xB3,0x58,0xAB), \
	rgb_t(0xC2,0x6A,0xBB), rgb_t(0xD2,0x7B,0xCA), rgb_t(0xE1,0x8C,0xDA), rgb_t(0xF0,0x9C,0xE9), \
	rgb_t(0xFF,0xAC,0xF8), rgb_t(0xFF,0xBC,0xFF), rgb_t(0xFF,0xCC,0xFF), rgb_t(0xFF,0xDB,0xFF   )

#define NTSC_HUE6_PAL_HUE7_U2 \
	rgb_t(0x18,0x00,0x64), rgb_t(0x2E,0x00,0x76), rgb_t(0x42,0x00,0x87), rgb_t(0x55,0x0D,0x97), \
	rgb_t(0x67,0x25,0xA7), rgb_t(0x78,0x3A,0xB7), rgb_t(0x89,0x4D,0xC7), rgb_t(0x9A,0x5F,0xD6), \
	rgb_t(0xAA,0x71,0xE5), rgb_t(0xBA,0x82,0xF4), rgb_t(0xC9,0x93,0xFF), rgb_t(0xD9,0xA3,0xFF), \
	rgb_t(0xE8,0xB3,0xFF), rgb_t(0xF7,0xC2,0xFF), rgb_t(0xFF,0xD2,0xFF), rgb_t(0xFF,0xE1,0xFF   )

#define NTSC_HUE7_PAL_HUE8_U2 \
	rgb_t(0x00,0x00,0x7F), rgb_t(0x00,0x00,0x90), rgb_t(0x1B,0x0A,0xA0), rgb_t(0x31,0x22,0xB0), \
	rgb_t(0x45,0x37,0xC0), rgb_t(0x57,0x4A,0xCF), rgb_t(0x69,0x5D,0xDF), rgb_t(0x7A,0x6F,0xEE), \
	rgb_t(0x8B,0x80,0xFD), rgb_t(0x9C,0x90,0xFF), rgb_t(0xAC,0xA1,0xFF), rgb_t(0xBC,0xB1,0xFF), \
	rgb_t(0xCB,0xC0,0xFF), rgb_t(0xDB,0xD0,0xFF), rgb_t(0xEA,0xDF,0xFF), rgb_t(0xF9,0xEE,0xFF   )

#define NTSC_HUE8_PAL_HUE9_U2 \
	rgb_t(0x00,0x00,0x7F), rgb_t(0x00,0x0D,0x90), rgb_t(0x00,0x25,0xA0), rgb_t(0x07,0x3A,0xB0), \
	rgb_t(0x20,0x4D,0xC0), rgb_t(0x35,0x5F,0xCF), rgb_t(0x49,0x71,0xDE), rgb_t(0x5B,0x82,0xEE), \
	rgb_t(0x6D,0x93,0xFC), rgb_t(0x7E,0xA3,0xFF), rgb_t(0x8F,0xB3,0xFF), rgb_t(0x9F,0xC2,0xFF), \
	rgb_t(0xAF,0xD2,0xFF), rgb_t(0xBF,0xE1,0xFF), rgb_t(0xCF,0xF0,0xFF), rgb_t(0xDE,0xFF,0xFF   )

#define NTSC_HUE9_PAL_HUE10_U2 \
	rgb_t(0x00,0x11,0x63), rgb_t(0x00,0x28,0x75), rgb_t(0x00,0x3C,0x86), rgb_t(0x00,0x4F,0x97), \
	rgb_t(0x00,0x62,0xA7), rgb_t(0x1A,0x73,0xB7), rgb_t(0x30,0x84,0xC6), rgb_t(0x44,0x95,0xD6), \
	rgb_t(0X57,0xA5,0xE5), rgb_t(0x68,0xB5,0xF4), rgb_t(0x7A,0xC5,0xFF), rgb_t(0x8B,0xD4,0xFF), \
	rgb_t(0x9B,0xE3,0xFF), rgb_t(0xAB,0xF2,0xFF), rgb_t(0xBB,0xFF,0xFF), rgb_t(0xCB,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11_U2 \
	rgb_t(0x00,0x25,0x2F), rgb_t(0x00,0x3A,0x43), rgb_t(0x00,0x4D,0x55), rgb_t(0x00,0x5F,0x67), \
	rgb_t(0x00,0x71,0x79), rgb_t(0x0F,0x82,0x8A), rgb_t(0x26,0x93,0x9A), rgb_t(0x3B,0xA3,0xAA), \
	rgb_t(0x4E,0xB3,0xBA), rgb_t(0x60,0xC3,0xCA), rgb_t(0x72,0xD2,0xD9), rgb_t(0x83,0xE1,0xE8), \
	rgb_t(0x93,0xF0,0xF7), rgb_t(0xA4,0xFF,0xFF), rgb_t(0xB4,0xFF,0xFF), rgb_t(0xC3,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U2 \
	rgb_t(0x00,0x2E,0x00), rgb_t(0x00,0x42,0x00), rgb_t(0x00,0x55,0x10), rgb_t(0x00,0x67,0x27), \
	rgb_t(0x00,0x78,0x3C), rgb_t(0x1A,0x89,0x4F), rgb_t(0x2F,0x99,0x61), rgb_t(0x43,0xAA,0x73), \
	rgb_t(0x56,0xB9,0x84), rgb_t(0x68,0xC9,0x94), rgb_t(0x79,0xD8,0xA5), rgb_t(0x8A,0xE7,0xB4), \
	rgb_t(0x9B,0xF6,0xC4), rgb_t(0xAB,0xFF,0xD4), rgb_t(0xBB,0xFF,0xE3), rgb_t(0xCA,0xFF,0xF2   )

#define NTSC_HUE12_PAL_HUE13_U2 \
	rgb_t(0x00,0x2B,0x00), rgb_t(0x00,0x3F,0x00), rgb_t(0x00,0x52,0x00), rgb_t(0x06,0x64,0x00), \
	rgb_t(0x1F,0x76,0x00), rgb_t(0x34,0x86,0x0C), rgb_t(0x48,0x97,0x24), rgb_t(0x5B,0xA7,0x39), \
	rgb_t(0x6C,0xB7,0x4C), rgb_t(0x7E,0xC7,0x5F), rgb_t(0x8E,0xD6,0x70), rgb_t(0x9F,0xE5,0x81), \
	rgb_t(0xAF,0xF4,0x92), rgb_t(0xBE,0xFF,0xA2), rgb_t(0xCE,0xFF,0xB2), rgb_t(0xDD,0xFF,0xC2   )

#define NTSC_HUE13_PAL_HUE14_U2 \
	rgb_t(0x00,0x1C,0x00), rgb_t(0x00,0x32,0x00), rgb_t(0x1A,0x45,0x00), rgb_t(0x30,0x58,0x00), \
	rgb_t(0x44,0x6A,0x00), rgb_t(0x56,0x7B,0x00), rgb_t(0x68,0x8C,0x00), rgb_t(0x7A,0x9D,0x06), \
	rgb_t(0x8A,0xAD,0x1F), rgb_t(0x9B,0xBC,0x35), rgb_t(0xAB,0xCC,0x48), rgb_t(0xBB,0xDB,0x5B), \
	rgb_t(0xCA,0xEA,0x6C), rgb_t(0xDA,0xF9,0x7E), rgb_t(0xE9,0xFF,0x8E), rgb_t(0xF8,0xFF,0x9F   )

#define NTSC_HUE14_PAL_HUE15_U2 \
	rgb_t(0x17,0x00,0x00), rgb_t(0x2D,0x1C,0x00), rgb_t(0x41,0x31,0x00), rgb_t(0x54,0x45,0x00), \
	rgb_t(0x66,0x58,0x00), rgb_t(0x77,0x69,0x00), rgb_t(0x88,0x7B,0x00), rgb_t(0x99,0x8C,0x00), \
	rgb_t(0xA9,0x9C,0x0D), rgb_t(0xB9,0xAC,0x24), rgb_t(0xC8,0xBC,0x39), rgb_t(0xD8,0xCB,0x4C), \
	rgb_t(0xE7,0xDB,0x5F), rgb_t(0xF6,0xEA,0x70), rgb_t(0xFF,0xF9,0x81), rgb_t(0xFF,0xFF,0x92   )

#define  NTSC_HUE15_U2 \
	rgb_t(0x39,0x00,0x00), rgb_t(0x4C,0x00,0x00), rgb_t(0x5E,0x18,0x00), rgb_t(0x70,0x2E,0x00), \
	rgb_t(0x81,0x42,0x00), rgb_t(0x92,0x55,0x00), rgb_t(0xA2,0x67,0x00), rgb_t(0xB2,0x78,0x08), \
	rgb_t(0xC2,0x89,0x21), rgb_t(0xD1,0x99,0x36), rgb_t(0xE0,0xA9,0x49), rgb_t(0xEF,0xB9,0x5C), \
	rgb_t(0xFE,0xC9,0x6D), rgb_t(0xFF,0xD8,0x7F), rgb_t(0xFF,0xE7,0x8F), rgb_t(0xFF,0xF6,0xA0   )

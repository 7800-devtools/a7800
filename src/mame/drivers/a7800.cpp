...
#define NTSC_HUE10_PAL_HUE11 \
	rgb_t(0x00,0x2E,0x4B), rgb_t(0x00,0x42,0x5E), rgb_t(0x00,0x55,0x6F), rgb_t(0x00,0x67,0x7F), \
	rgb_t(0x00,0x78,0x8F), rgb_t(0x00,0x88,0x9E), rgb_t(0x00,0x97,0xAD), rgb_t(0x14,0xA6,0xBC), \
	rgb_t(0x2D,0xB5,0xCA), rgb_t(0x41,0xC3,0xD8), rgb_t(0x54,0xD1,0xE5), rgb_t(0x66,0xDF,0xF3), \
	rgb_t(0x77,0xED,0xFF), rgb_t(0x87,0xFA,0xFF), rgb_t(0x97,0xFF,0xFF), rgb_t(0xA6,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12 \
	rgb_t(0x00,0x3B,0x00), rgb_t(0x00,0x4F,0x00), rgb_t(0x00,0x61,0x00), rgb_t(0x00,0x72,0x1B), \
	rgb_t(0x00,0x82,0x32), rgb_t(0x00,0x92,0x46), rgb_t(0x00,0xA1,0x59), rgb_t(0x11,0xB0,0x6A), \
	rgb_t(0x2A,0xBE,0x7B), rgb_t(0x3F,0xCC,0x8B), rgb_t(0x52,0xDA,0x9A), rgb_t(0x64,0xE8,0xA9), \
	rgb_t(0x75,0xF5,0xB8), rgb_t(0x85,0xFF,0xC6), rgb_t(0x95,0xFF,0xD4), rgb_t(0xA4,0xFF,0xE2   )

#define NTSC_HUE12_PAL_HUE13 \
	rgb_t(0x00,0x40,0x00), rgb_t(0x00,0x53,0x00), rgb_t(0x00,0x64,0x00), rgb_t(0x00,0x75,0x00), \
	rgb_t(0x00,0x85,0x00), rgb_t(0x00,0x95,0x00), rgb_t(0x16,0xA4,0x00), rgb_t(0x2E,0xB3,0x00), \
	rgb_t(0x43,0xC1,0x1F), rgb_t(0x56,0xCF,0x35), rgb_t(0x67,0xDD,0x49), rgb_t(0x78,0xEB,0x5C), \
	rgb_t(0x88,0xF8,0x6D), rgb_t(0x98,0xFF,0x7D), rgb_t(0xA7,0xFF,0x8D), rgb_t(0xB5,0xFF,0x9D   )
...
#define NTSC_HUE13_PAL_HUE14 \
	...
	rgb_t(0x6B,0xBD,0x00), rgb_t(0x7C,0xCB,0x00), rgb_t(0x8C,0xD9,0x00), rgb_t(0x9B,0xE7,0x13), \
	rgb_t(0xAA,0xF4,0x2B), rgb_t(0xB9,0xFF,0x40), rgb_t(0xC7,0xFF,0x53), rgb_t(0xD5,0xFF,0x65   )
...
#define NTSC_HUE10_PAL_HUE11_U1 \
	rgb_t(0x00,0x34,0x26), rgb_t(0x00,0x48,0x3B), rgb_t(0x00,0x5A,0x4F), rgb_t(0x00,0x6C,0x61), \
	rgb_t(0x00,0x7C,0x72), rgb_t(0x00,0x8C,0x82), rgb_t(0x00,0x9B,0x92), rgb_t(0x0F,0xAA,0xA1), \
	rgb_t(0x28,0xB9,0xB0), rgb_t(0x3E,0xC7,0xBE), rgb_t(0x51,0xD5,0xCC), rgb_t(0x63,0xE3,0xDA), \
	rgb_t(0x74,0xF0,0xE8), rgb_t(0x84,0xFD,0xF5), rgb_t(0x94,0xFF,0xFF), rgb_t(0xA3,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U1 \
	rgb_t(0x00,0x3E,0x00), rgb_t(0x00,0x51,0x00), rgb_t(0x00,0x63,0x00), rgb_t(0x00,0x74,0x00), \
	rgb_t(0x00,0x84,0x00), rgb_t(0x00,0x94,0x1B), rgb_t(0x00,0xA3,0x32), rgb_t(0x1A,0xB2,0x46), \
	rgb_t(0x31,0xC0,0x59), rgb_t(0x45,0xCE,0x6A), rgb_t(0x58,0xDC,0x7B), rgb_t(0x69,0xEA,0x8B), \
	rgb_t(0x7A,0xF7,0x9A), rgb_t(0x8A,0xFF,0xA9), rgb_t(0x9A,0xFF,0xB8), rgb_t(0xA9,0xFF,0xC6   )

#define NTSC_HUE12_PAL_HUE13_U1 \
	rgb_t(0x00,0x3E,0x00), rgb_t(0x00,0x51,0x00), rgb_t(0x00,0x63,0x00), rgb_t(0x00,0x74,0x00), \
	rgb_t(0x00,0x84,0x00), rgb_t(0x12,0x94,0x00), rgb_t(0x2B,0xA3,0x00), rgb_t(0x40,0xB2,0x00), \
	rgb_t(0x53,0xC0,0x00), rgb_t(0x65,0xCE,0x0B), rgb_t(0x76,0xDC,0x26), rgb_t(0x86,0xEA,0x3B), \
	rgb_t(0x95,0xF7,0x4F), rgb_t(0xA4,0xFF,0x61), rgb_t(0xB3,0xFF,0x72), rgb_t(0xC2,0xFF,0x82   )

#define NTSC_HUE13_PAL_HUE14_U1 \
	rgb_t(0x00,0x34,0x00), rgb_t(0x00,0x48,0x00), rgb_t(0x08,0x5A,0x00), rgb_t(0x24,0x6C,0x00), \
	rgb_t(0x39,0x7C,0x00), rgb_t(0x4D,0x8C,0x00), rgb_t(0x5F,0x9C,0x00), rgb_t(0x70,0xAB,0x00), \
	rgb_t(0x81,0xB9,0x00), rgb_t(0x90,0xC7,0x00), rgb_t(0xA0,0xD5,0x00), rgb_t(0xAF,0xE3,0x00), \
	rgb_t(0xBD,0xF0,0x15), rgb_t(0xCB,0xFE,0x2D), rgb_t(0xD9,0xFF,0x42), rgb_t(0xE7,0xFF,0x55   )
...
#define NTSC_HUE10_PAL_HUE11_U2 \
	rgb_t(0x00,0x38,0x00), rgb_t(0x00,0x4C,0x0F), rgb_t(0x00,0x5E,0x29), rgb_t(0x00,0x6F,0x3E), \
	rgb_t(0x00,0x80,0x51), rgb_t(0x00,0x90,0x63), rgb_t(0x00,0x9F,0x74), rgb_t(0x0E,0xAE,0x84), \
	rgb_t(0x28,0xBC,0x94), rgb_t(0x3D,0xCA,0xA3), rgb_t(0x50,0xD8,0xB2), rgb_t(0x62,0xE6,0xC0), \
	rgb_t(0x73,0xF3,0xCE), rgb_t(0x83,0xFF,0xDC), rgb_t(0x93,0xFF,0xEA), rgb_t(0xA2,0xFF,0xF7   )

#define NTSC_HUE11_PAL_HUE12_U2 \
	rgb_t(0x00,0x3F,0x00), rgb_t(0x00,0x52,0x00), rgb_t(0x00,0x64,0x00), rgb_t(0x00,0x75,0x00), \
	rgb_t(0x00,0x85,0x00), rgb_t(0x00,0x95,0x00), rgb_t(0x0B,0xA4,0x00), rgb_t(0x26,0xB3,0x1E), \
	rgb_t(0x3C,0xC1,0x35), rgb_t(0x4F,0xCF,0x49), rgb_t(0x61,0xDD,0x5B), rgb_t(0x72,0xEB,0x6C), \
	rgb_t(0x82,0xF8,0x7D), rgb_t(0x92,0xFF,0x8D), rgb_t(0xA1,0xFF,0x9C), rgb_t(0xB0,0xFF,0xAB   )
...
#define NTSC_HUE12_PAL_HUE13_U2 \
	...
	rgb_t(0x65,0xBE,0x00), rgb_t(0x76,0xCC,0x00), rgb_t(0x86,0xDA,0x00), rgb_t(0x96,0xE8,0x1D), \
	rgb_t(0xA5,0xF5,0x34), rgb_t(0xB3,0xFF,0x48), rgb_t(0xC2,0xFF,0x5A), rgb_t(0xD0,0xFF,0x6C   )
...
#define NTSC_HUE13_PAL_HUE14_U2 \
	...
	rgb_t(0xD0,0xEB,0x07), rgb_t(0xDE,0xF9,0x23), rgb_t(0xEC,0xFF,0x39), rgb_t(0xF9,0xFF,0x4D   )

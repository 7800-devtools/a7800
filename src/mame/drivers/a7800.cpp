...
#define NTSC_HUE0_PAL_HUE0 \
    rgb_t(0x00,0x00,0x00), rgb_t(0x0A,0x0A,0x0A), rgb_t(0x22,0x22,0x22), rgb_t(0x37,0x37,0x37), \
    rgb_t(0x4B,0x4B,0x4B), rgb_t(0x5D,0x5D,0x5D), rgb_t(0x6F,0x6F,0x6F), rgb_t(0x81,0x81,0x81), \
    rgb_t(0x91,0x91,0x91), rgb_t(0xA2,0xA2,0xA2), rgb_t(0xB2,0xB2,0xB2), rgb_t(0xC2,0xC2,0xC2), \
    rgb_t(0xD2,0xD2,0xD2), rgb_t(0xE1,0xE1,0xE1), rgb_t(0xF0,0xF0,0xF0), rgb_t(0xFF,0xFF,0xFF   )

#define NTSC_HUE1_PAL_HUE2 \
	rgb_t(0x4E,0x22,0x00), rgb_t(0x5D,0x31,0x00), rgb_t(0x6C,0x40,0x00), rgb_t(0x7B,0x50,0x00), \
    rgb_t(0x8B,0x5F,0x00), rgb_t(0x9A,0x6E,0x00), rgb_t(0xA9,0x7E,0x00), rgb_t(0xB9,0x8D,0x00), \
    rgb_t(0xC8,0x9C,0x00), rgb_t(0xD7,0xAC,0x00), rgb_t(0xE7,0xBB,0x00), rgb_t(0xF6,0xCA,0x00), \
    rgb_t(0xFF,0xD9,0x00), rgb_t(0xFF,0xE9,0x01), rgb_t(0xFF,0xF8,0x11), rgb_t(0xFF,0xFF,0x20   )

#define PAL_HUE1 \
	rgb_t(0x19,0x34,0x00), rgb_t(0x29,0x43,0x00), rgb_t(0x38,0x53,0x00), rgb_t(0x47,0x62,0x00), \
	rgb_t(0x57,0x71,0x00), rgb_t(0x66,0x81,0x00), rgb_t(0x75,0x90,0x00), rgb_t(0x85,0x9F,0x00), \
	rgb_t(0x94,0xAE,0x00), rgb_t(0xA3,0xBE,0x00), rgb_t(0xB2,0xCD,0x00), rgb_t(0xC2,0xDC,0x00), \
	rgb_t(0xD1,0xEC,0x00), rgb_t(0xE0,0xFB,0x01), rgb_t(0xF0,0xFF,0x11), rgb_t(0xFF,0xFF,0x20   )

#define NTSC_HUE2_PAL_HUE3 \
	rgb_t(0x7B,0x0D,0x00), rgb_t(0x8A,0x1C,0x00), rgb_t(0x9A,0x2B,0x00), rgb_t(0xA9,0x3B,0x00), \
    rgb_t(0xB8,0x4A,0x00), rgb_t(0xC7,0x59,0x00), rgb_t(0xD7,0x69,0x00), rgb_t(0xE6,0x78,0x00), \
    rgb_t(0xF5,0x87,0x00), rgb_t(0xFF,0x97,0x00), rgb_t(0xFF,0xA6,0x00), rgb_t(0xFF,0xB5,0x0D), \
    rgb_t(0xFF,0xC4,0x1D), rgb_t(0xFF,0xD4,0x2C), rgb_t(0xFF,0xE3,0x3B), rgb_t(0xFF,0xF2,0x4B   )

#define NTSC_HUE3_PAL_HUE4 \
	rgb_t(0x95,0x00,0x00), rgb_t(0xA5,0x0A,0x00), rgb_t(0xB4,0x19,0x00), rgb_t(0xC3,0x28,0x00), \
    rgb_t(0xD2,0x38,0x00), rgb_t(0xE2,0x47,0x00), rgb_t(0xF1,0x56,0x0F), rgb_t(0xFF,0x66,0x1E), \
    rgb_t(0xFF,0x75,0x2E), rgb_t(0xFF,0x84,0x3D), rgb_t(0xFF,0x93,0x4C), rgb_t(0xFF,0xA3,0x5B), \
    rgb_t(0xFF,0xB2,0x6B), rgb_t(0xFF,0xC1,0x7A), rgb_t(0xFF,0xD1,0x89), rgb_t(0xFF,0xE0,0x99   )

#define NTSC_HUE4_PAL_HUE5 \
	rgb_t(0x97,0x00,0x15), rgb_t(0xA6,0x00,0x25), rgb_t(0xB6,0x0D,0x34), rgb_t(0xC5,0x1C,0x43), \
	rgb_t(0xD4,0x2B,0x53), rgb_t(0xE4,0x3B,0x62), rgb_t(0xF3,0x4A,0x71), rgb_t(0xFF,0x59,0x81), \
	rgb_t(0xFF,0x68,0x90), rgb_t(0xFF,0x78,0x9F), rgb_t(0xFF,0x87,0xAE), rgb_t(0xFF,0x96,0xBE), \
	rgb_t(0xFF,0xA6,0xCD), rgb_t(0xFF,0xB5,0xDC), rgb_t(0xFF,0xC4,0xEC), rgb_t(0xFF,0xD4,0xFB   )

#define NTSC_HUE5_PAL_HUE6 \
	rgb_t(0x80,0x00,0x79), rgb_t(0x8F,0x00,0x88), rgb_t(0x9F,0x09,0x97), rgb_t(0xAE,0x18,0xA7), \
	rgb_t(0xBD,0x27,0xB6), rgb_t(0xCD,0x37,0xC5), rgb_t(0xDC,0x46,0xD4), rgb_t(0xEB,0x55,0xE4), \
	rgb_t(0xFB,0x65,0xF3), rgb_t(0xFF,0x74,0xFF), rgb_t(0xFF,0x83,0xFF), rgb_t(0xFF,0x93,0xFF), \
	rgb_t(0xFF,0xA2,0xFF), rgb_t(0xFF,0xB1,0xFF), rgb_t(0xFF,0xC0,0xFF), rgb_t(0xFF,0xD0,0xFF   )

#define NTSC_HUE6_PAL_HUE7 \
	rgb_t(0x55,0x00,0xC9), rgb_t(0x64,0x00,0xD8), rgb_t(0x74,0x0E,0xE8), rgb_t(0x83,0x1E,0xF7), \
	rgb_t(0x92,0x2D,0xFF), rgb_t(0xA1,0x3C,0xFF), rgb_t(0xB1,0x4C,0xFF), rgb_t(0xC0,0x5B,0xFF), \
	rgb_t(0xCF,0x6A,0xFF), rgb_t(0xDF,0x7A,0xFF), rgb_t(0xEE,0x89,0xFF), rgb_t(0xFD,0x98,0xFF), \
	rgb_t(0xFF,0xA7,0xFF), rgb_t(0xFF,0xB7,0xFF), rgb_t(0xFF,0xC6,0xFF), rgb_t(0xFF,0xD5,0xFF   )

#define NTSC_HUE7_PAL_HUE8 \
	rgb_t(0x1E,0x00,0xF7), rgb_t(0x2D,0x0D,0xFF), rgb_t(0x3D,0x1C,0xFF), rgb_t(0x4C,0x2B,0xFF), \
	rgb_t(0x5B,0x3B,0xFF), rgb_t(0x6A,0x4A,0xFF), rgb_t(0x7A,0x59,0xFF), rgb_t(0x89,0x69,0xFF), \
	rgb_t(0x98,0x78,0xFF), rgb_t(0xA8,0x87,0xFF), rgb_t(0xB7,0x97,0xFF), rgb_t(0xC6,0xA6,0xFF), \
	rgb_t(0xD6,0xB5,0xFF), rgb_t(0xE5,0xC4,0xFF), rgb_t(0xF4,0xD4,0xFF), rgb_t(0xFF,0xE3,0xFF   )

#define NTSC_HUE8_PAL_HUE9 \
	rgb_t(0x00,0x11,0xF9), rgb_t(0x00,0x20,0xFF), rgb_t(0x05,0x2F,0xFF), rgb_t(0x14,0x3F,0xFF), \
	rgb_t(0x23,0x4E,0xFF), rgb_t(0x33,0x5D,0xFF), rgb_t(0x42,0x6D,0xFF), rgb_t(0x51,0x7C,0xFF), \
	rgb_t(0x61,0x8B,0xFF), rgb_t(0x70,0x9B,0xFF), rgb_t(0x7F,0xAA,0xFF), rgb_t(0x8E,0xB9,0xFF), \
	rgb_t(0x9E,0xC8,0xFF), rgb_t(0xAD,0xD8,0xFF), rgb_t(0xBC,0xE7,0xFF), rgb_t(0xCC,0xF6,0xFF   )

#define NTSC_HUE9_PAL_HUE10 \
	rgb_t(0x00,0x26,0xCF), rgb_t(0x00,0x35,0xDE), rgb_t(0x00,0x44,0xED), rgb_t(0x00,0x54,0xFD), \
	rgb_t(0x00,0x63,0xFF), rgb_t(0x05,0x72,0xFF), rgb_t(0x14,0x82,0xFF), rgb_t(0x24,0x91,0xFF), \
	rgb_t(0x33,0xA0,0xFF), rgb_t(0x42,0xB0,0xFF), rgb_t(0x51,0xBF,0xFF), rgb_t(0x61,0xCE,0xFF), \
	rgb_t(0x70,0xDD,0xFF), rgb_t(0x7F,0xED,0xFF), rgb_t(0x8F,0xFC,0xFF), rgb_t(0x9E,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11 \
	rgb_t(0x00,0x38,0x81), rgb_t(0x00,0x48,0x90), rgb_t(0x00,0x57,0xA0), rgb_t(0x00,0x66,0xAF), \
	rgb_t(0x00,0x76,0xBE), rgb_t(0x00,0x85,0xCE), rgb_t(0x00,0x94,0xDD), rgb_t(0x09,0xA3,0xEC), \
	rgb_t(0x18,0xB3,0xFB), rgb_t(0x28,0xC2,0xFF), rgb_t(0x37,0xD1,0xFF), rgb_t(0x46,0xE1,0xFF), \
	rgb_t(0x56,0xF0,0xFF), rgb_t(0x65,0xFF,0xFF), rgb_t(0x74,0xFF,0xFF), rgb_t(0x83,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12 \
	rgb_t(0x00,0x45,0x1F), rgb_t(0x00,0x54,0x2E), rgb_t(0x00,0x63,0x3D), rgb_t(0x00,0x73,0x4D), \
	rgb_t(0x00,0x82,0x5C), rgb_t(0x00,0x91,0x6B), rgb_t(0x00,0xA1,0x7B), rgb_t(0x07,0xB0,0x8A), \
	rgb_t(0x16,0xBF,0x99), rgb_t(0x26,0xCF,0xA9), rgb_t(0x35,0xDE,0xB8), rgb_t(0x44,0xED,0xC7), \
	rgb_t(0x53,0xFC,0xD6), rgb_t(0x63,0xFF,0xE6), rgb_t(0x72,0xFF,0xF5), rgb_t(0x81,0xFF,0xFF   )

#define NTSC_HUE12_PAL_HUE13 \
	rgb_t(0x00,0x49,0x00), rgb_t(0x00,0x58,0x00), rgb_t(0x00,0x67,0x00), rgb_t(0x00,0x77,0x00), \
	rgb_t(0x00,0x86,0x00), rgb_t(0x00,0x95,0x08), rgb_t(0x0E,0xA5,0x17), rgb_t(0x1E,0xB4,0x27), \
	rgb_t(0x2D,0xC3,0x36), rgb_t(0x3C,0xD2,0x45), rgb_t(0x4B,0xE2,0x55), rgb_t(0x5B,0xF1,0x64), \
	rgb_t(0x6A,0xFF,0x73), rgb_t(0x79,0xFF,0x82), rgb_t(0x89,0xFF,0x92), rgb_t(0x98,0xFF,0xA1   )

#define NTSC_HUE13_PAL_HUE14 \
	rgb_t(0x00,0x43,0x00), rgb_t(0x00,0x53,0x00), rgb_t(0x00,0x62,0x00), rgb_t(0x0B,0x71,0x00), \
	rgb_t(0x1B,0x80,0x00), rgb_t(0x2A,0x90,0x00), rgb_t(0x39,0x9F,0x00), rgb_t(0x49,0xAE,0x00), \
	rgb_t(0x58,0xBE,0x00), rgb_t(0x67,0xCD,0x00), rgb_t(0x76,0xDC,0x04), rgb_t(0x86,0xEC,0x13), \
	rgb_t(0x95,0xFB,0x22), rgb_t(0xA4,0xFF,0x32), rgb_t(0xB4,0xFF,0x41), rgb_t(0xC3,0xFF,0x50   )

#define NTSC_HUE14_PAL_HUE15 \
	rgb_t(0x14,0x36,0x00), rgb_t(0x24,0x45,0x00), rgb_t(0x33,0x54,0x00), rgb_t(0x42,0x64,0x00), \
	rgb_t(0x51,0x73,0x00), rgb_t(0x61,0x82,0x00), rgb_t(0x70,0x91,0x00), rgb_t(0x7F,0xA1,0x00), \
	rgb_t(0x8F,0xB0,0x00), rgb_t(0x9E,0xBF,0x00), rgb_t(0xAD,0xCF,0x00), rgb_t(0xBD,0xDE,0x00), \
	rgb_t(0xCC,0xED,0x00), rgb_t(0xD8,0xFD,0x04), rgb_t(0xEA,0xFF,0x13), rgb_t(0xFA,0xFF,0x22   )

#define NTSC_HUE15 \
	rgb_t(0x4C,0x22,0x00), rgb_t(0x5B,0x32,0x00), rgb_t(0x6B,0x41,0x00), rgb_t(0x7A,0x50,0x00), \
	rgb_t(0x89,0x60,0x00), rgb_t(0x99,0x6F,0x00), rgb_t(0xA8,0x7E,0x00), rgb_t(0xB7,0x8E,0x00), \
	rgb_t(0xC7,0x9D,0x00), rgb_t(0xD6,0xAC,0x00), rgb_t(0xE5,0xBB,0x00), rgb_t(0xF4,0xCB,0x00), \
	rgb_t(0xFF,0xDA,0x00), rgb_t(0xFF,0xE9,0x01), rgb_t(0xFF,0xF9,0x10), rgb_t(0xFF,0xFF,0x1F   )
...
#define NTSC_HUE2_PAL_HUE3_U1 \
	rgb_t(0x7C,0x0C,0x00), rgb_t(0x8C,0x1B,0x00), rgb_t(0x9B,0x2B,0x00), rgb_t(0xAA,0x3A,0x00), \
    rgb_t(0xBA,0x49,0x00), rgb_t(0xC9,0x59,0x00), rgb_t(0xD8,0x68,0x00), rgb_t(0xE8,0x77,0x00), \
    rgb_t(0xF7,0x87,0x00), rgb_t(0xFF,0x96,0x00), rgb_t(0xFF,0xA5,0x00), rgb_t(0xFF,0xB4,0x10), \
    rgb_t(0xFF,0xC4,0x1F), rgb_t(0xFF,0xD3,0x2E), rgb_t(0xFF,0xE2,0x3E), rgb_t(0xFF,0xF2,0x4D   )

#define NTSC_HUE3_PAL_HUE4_U1 \
	rgb_t(0x96,0x00,0x00), rgb_t(0xA6,0x08,0x00), rgb_t(0xB5,0x18,0x00), rgb_t(0xC4,0x27,0x00), \
    rgb_t(0xD3,0x36,0x00), rgb_t(0xE3,0x46,0x07), rgb_t(0xF2,0x55,0x16), rgb_t(0xFF,0x64,0x25), \
    rgb_t(0xFF,0x74,0x35), rgb_t(0xFF,0x83,0x44), rgb_t(0xFF,0x92,0x53), rgb_t(0xFF,0xA1,0x63), \
    rgb_t(0xFF,0xB1,0x72), rgb_t(0xFF,0xC0,0x81), rgb_t(0xFF,0xCF,0x91), rgb_t(0xFF,0xDF,0xA0   )

#define NTSC_HUE4_PAL_HUE5_U1 \
	rgb_t(0x96,0x00,0x21), rgb_t(0xA5,0x00,0x31), rgb_t(0xB4,0x0C,0x40), rgb_t(0xC4,0x1B,0x4F), \
	rgb_t(0xD3,0x2A,0x5F), rgb_t(0xE2,0x3A,0x6E), rgb_t(0xF1,0x49,0x7D), rgb_t(0xFF,0x58,0x8D), \
	rgb_t(0xFF,0x68,0x9C), rgb_t(0xFF,0x77,0xAB), rgb_t(0xFF,0x86,0xBA), rgb_t(0xFF,0x95,0xCA), \
	rgb_t(0xFF,0xA5,0xD9), rgb_t(0xFF,0xB4,0xE8), rgb_t(0xFF,0xC3,0xF8), rgb_t(0xFF,0xD3,0xFF   )

#define NTSC_HUE5_PAL_HUE6_U1 \
	rgb_t(0x7B,0x00,0x87), rgb_t(0x8A,0x00,0x96), rgb_t(0x99,0x09,0xA5), rgb_t(0xA8,0x18,0xB5), \
	rgb_t(0xB8,0x28,0xC4), rgb_t(0xC7,0x37,0xD3), rgb_t(0xD6,0x46,0xE3), rgb_t(0xE6,0x56,0xF2), \
	rgb_t(0xF5,0x65,0xFF), rgb_t(0xFF,0x74,0xFF), rgb_t(0xFF,0x84,0xFF), rgb_t(0xFF,0x93,0xFF), \
	rgb_t(0xFF,0xA2,0xFF), rgb_t(0xFF,0xB1,0xFF), rgb_t(0xFF,0xC1,0xFF), rgb_t(0xFF,0xD0,0xFF   )

#define NTSC_HUE6_PAL_HUE7_U1 \
	rgb_t(0x4B,0x00,0xD5), rgb_t(0x5A,0x01,0xE4), rgb_t(0x69,0x11,0xF4), rgb_t(0x79,0x20,0xFF), \
	rgb_t(0x88,0x2F,0xFF), rgb_t(0x97,0x3E,0xFF), rgb_t(0xA7,0x4E,0xFF), rgb_t(0xB6,0x5D,0xFF), \
	rgb_t(0xC5,0x6C,0xFF), rgb_t(0xD5,0x7C,0xFF), rgb_t(0xE4,0x8B,0xFF), rgb_t(0xF3,0x9A,0xFF), \
	rgb_t(0xFF,0xAA,0xFF), rgb_t(0xFF,0xB9,0xFF), rgb_t(0xFF,0xC8,0xFF), rgb_t(0xFF,0xD7,0xFF   )

#define NTSC_HUE7_PAL_HUE8_U1 \
	rgb_t(0x11,0x02,0xFB), rgb_t(0x20,0x11,0xFF), rgb_t(0x2F,0x20,0xFF), rgb_t(0x3E,0x30,0xFF), \
	rgb_t(0x4E,0x3F,0xFF), rgb_t(0x5D,0x4E,0xFF), rgb_t(0x6C,0x5E,0xFF), rgb_t(0x7C,0x6D,0xFF), \
	rgb_t(0x8B,0x7C,0xFF), rgb_t(0x9A,0x8B,0xFF), rgb_t(0xAA,0x9B,0xFF), rgb_t(0xB9,0xAA,0xFF), \
	rgb_t(0xC8,0xB9,0xFF), rgb_t(0xD7,0xC9,0xFF), rgb_t(0xE7,0xD8,0xFF), rgb_t(0xF6,0xE7,0xFF   )

#define NTSC_HUE8_PAL_HUE9_U1 \
	rgb_t(0x00,0x17,0xF2), rgb_t(0x00,0x26,0xFF), rgb_t(0x00,0x35,0xFF), rgb_t(0x06,0x44,0xFF), \
	rgb_t(0x15,0x54,0xFF), rgb_t(0x25,0x63,0xFF), rgb_t(0x34,0x72,0xFF), rgb_t(0x43,0x82,0xFF), \
	rgb_t(0x53,0x91,0xFF), rgb_t(0x62,0xA0,0xFF), rgb_t(0x71,0xB0,0xFF), rgb_t(0x81,0xBF,0xFF), \
	rgb_t(0x90,0xCE,0xFF), rgb_t(0x9F,0xDD,0xFF), rgb_t(0xAE,0xED,0xFF), rgb_t(0xBE,0xFC,0xFF   )

#define NTSC_HUE9_PAL_HUE10_U1 \
	rgb_t(0x00,0x2C,0xBA), rgb_t(0x00,0x3B,0xC9), rgb_t(0x00,0x4B,0xD8), rgb_t(0x00,0x5A,0xE8), \
	rgb_t(0x00,0x69,0xF7), rgb_t(0x00,0x79,0xFF), rgb_t(0x0A,0x88,0xFF), rgb_t(0x19,0x97,0xFF), \
	rgb_t(0x28,0xA6,0xFF), rgb_t(0x38,0xB6,0xFF), rgb_t(0x47,0xC5,0xFF), rgb_t(0x56,0xD4,0xFF), \
	rgb_t(0x65,0xE4,0xFF), rgb_t(0x75,0xF3,0xFF), rgb_t(0x84,0xFF,0xFF), rgb_t(0x93,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11_U1 \
	rgb_t(0x00,0x3E,0x60), rgb_t(0x00,0x4D,0x6F), rgb_t(0x00,0x5C,0x7F), rgb_t(0x00,0x6B,0x8E), \
	rgb_t(0x00,0x7B,0x9D), rgb_t(0x00,0x8A,0xAC), rgb_t(0x00,0x99,0xBC), rgb_t(0x05,0xA9,0xCB), \
	rgb_t(0x15,0xB8,0xDA), rgb_t(0x24,0xC7,0xEA), rgb_t(0x33,0xD7,0xF9), rgb_t(0x43,0xE6,0xFF), \
	rgb_t(0x52,0xF5,0xFF), rgb_t(0x61,0xFF,0xFF), rgb_t(0x70,0xFF,0xFF), rgb_t(0x80,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U1 \
	rgb_t(0x00,0x47,0x00), rgb_t(0x00,0x57,0x06), rgb_t(0x00,0x66,0x16), rgb_t(0x00,0x75,0x25), \
	rgb_t(0x00,0x85,0x34), rgb_t(0x00,0x94,0x44), rgb_t(0x00,0xA3,0x53), rgb_t(0x0D,0xB3,0x62), \
	rgb_t(0x1C,0xC2,0x72), rgb_t(0x2C,0xD1,0x81), rgb_t(0x3B,0xE0,0x90), rgb_t(0x4A,0xF0,0x9F), \
	rgb_t(0x59,0xFF,0xAF), rgb_t(0x69,0xFF,0xBE), rgb_t(0x78,0xFF,0xCD), rgb_t(0x87,0xFF,0xDD   )

#define NTSC_HUE12_PAL_HUE13_U1 \
	rgb_t(0x00,0x48,0x00), rgb_t(0x00,0x57,0x00), rgb_t(0x00,0x66,0x00), rgb_t(0x00,0x75,0x00), \
	rgb_t(0x00,0x85,0x00), rgb_t(0x0F,0x94,0x00), rgb_t(0x1F,0xA3,0x00), rgb_t(0x2E,0xB3,0x01), \
	rgb_t(0x3D,0xC2,0x10), rgb_t(0x4D,0xD1,0x1F), rgb_t(0x5C,0xE1,0x2F), rgb_t(0x6B,0xF0,0x3E), \
	rgb_t(0x7A,0xFF,0x4D), rgb_t(0x8A,0xFF,0x5D), rgb_t(0x99,0xFF,0x6C), rgb_t(0xA8,0xFF,0x7B   )

#define NTSC_HUE13_PAL_HUE14_U1 \
	rgb_t(0x00,0x3E,0x00), rgb_t(0x06,0x4D,0x00), rgb_t(0x15,0x5C,0x00), rgb_t(0x24,0x6C,0x00), \
	rgb_t(0x33,0x7B,0x00), rgb_t(0x43,0x8A,0x00), rgb_t(0x52,0x9A,0x00), rgb_t(0x61,0xA9,0x00), \
	rgb_t(0x71,0xB8,0x00), rgb_t(0x80,0xC7,0x00), rgb_t(0x8F,0xD7,0x00), rgb_t(0x9F,0xE6,0x00), \
	rgb_t(0xAE,0xF5,0x08), rgb_t(0xBD,0xFF,0x17), rgb_t(0xCC,0xFF,0x26), rgb_t(0xDC,0xFF,0x36   )

#define NTSC_HUE14_PAL_HUE15_U1 \
	rgb_t(0x31,0x2C,0x00), rgb_t(0x40,0x3C,0x00), rgb_t(0x50,0x4B,0x00), rgb_t(0x5F,0x5A,0x00), \
	rgb_t(0x6E,0x6A,0x00), rgb_t(0x7E,0x79,0x00), rgb_t(0x8D,0x88,0x00), rgb_t(0x9C,0x97,0x00), \
	rgb_t(0xAC,0xA7,0x00), rgb_t(0xBB,0xB6,0x00), rgb_t(0xCA,0xC5,0x00), rgb_t(0xD9,0xD5,0x00), \
	rgb_t(0xE9,0xE4,0x00), rgb_t(0xF8,0xF3,0x00), rgb_t(0xFF,0xFF,0x0C), rgb_t(0xFF,0xFF,0x1B   )

#define NTSC_HUE15_U1 \
	rgb_t(0x67,0x17,0x00), rgb_t(0x76,0x26,0x00), rgb_t(0x86,0x36,0x00), rgb_t(0x95,0x45,0x00), \
	rgb_t(0xA4,0x54,0x00), rgb_t(0xB4,0x63,0x00), rgb_t(0xC3,0x73,0x00), rgb_t(0xD2,0x82,0x00), \
	rgb_t(0xE1,0x91,0x00), rgb_t(0xF1,0xA1,0x00), rgb_t(0xFF,0xB0,0x00), rgb_t(0xFF,0xBF,0x00), \
	rgb_t(0xFF,0xCF,0x03), rgb_t(0xFF,0xDE,0x12), rgb_t(0xFF,0xED,0x22), rgb_t(0xFF,0xFC,0x31   )
...
#define NTSC_HUE2_PAL_HUE3_U2 \
	rgb_t(0x7E,0x0B,0x00), rgb_t(0x8D,0x1B,0x00), rgb_t(0x9C,0x2A,0x00), rgb_t(0xAC,0x39,0x00), \
    rgb_t(0xBB,0x49,0x00), rgb_t(0xCA,0x58,0x00), rgb_t(0xDA,0x67,0x00), rgb_t(0xE9,0x76,0x00), \
    rgb_t(0xF8,0x86,0x00), rgb_t(0xFF,0x95,0x00), rgb_t(0xFF,0xA4,0x03), rgb_t(0xFF,0xB4,0x12), \
    rgb_t(0xFF,0xC3,0x22), rgb_t(0xFF,0xD2,0x31), rgb_t(0xFF,0xE2,0x40), rgb_t(0xFF,0xF1,0x4F   )

#define NTSC_HUE3_PAL_HUE4_U2 \
	rgb_t(0x97,0x00,0x00), rgb_t(0xA6,0x07,0x00), rgb_t(0xB6,0x17,0x00), rgb_t(0xC5,0x26,0x00), \
    rgb_t(0xD4,0x35,0x00), rgb_t(0xE4,0x45,0x0E), rgb_t(0xF3,0x54,0x1D), rgb_t(0xFF,0x63,0x2D), \
    rgb_t(0xFF,0x72,0x3C), rgb_t(0xFF,0x82,0x4B), rgb_t(0xFF,0x91,0x5B), rgb_t(0xFF,0xA0,0x6A), \
    rgb_t(0xFF,0xB0,0x79), rgb_t(0xFF,0xBF,0x89), rgb_t(0xFF,0xCE,0x98), rgb_t(0xFF,0xDE,0xA7   )

#define NTSC_HUE4_PAL_HUE5_U2 \
	rgb_t(0x94,0x00,0x2D), rgb_t(0xA3,0x00,0x3D), rgb_t(0xB2,0x0B,0x4C), rgb_t(0xC2,0x1A,0x5B), \
	rgb_t(0xD1,0x2A,0x6B), rgb_t(0xE0,0x39,0x7A), rgb_t(0xF0,0x48,0x89), rgb_t(0xFF,0x57,0x98), \
	rgb_t(0xFF,0x67,0xA8), rgb_t(0xFF,0x76,0xB7), rgb_t(0xFF,0x85,0xC6), rgb_t(0xFF,0x95,0xD6), \
	rgb_t(0xFF,0xA4,0xE5), rgb_t(0xFF,0xB3,0xF4), rgb_t(0xFF,0xC3,0xFF), rgb_t(0xFF,0xD2,0xFF   )

#define NTSC_HUE5_PAL_HUE6_U2 \
	rgb_t(0x74,0x00,0x95), rgb_t(0x84,0x00,0xA4), rgb_t(0x93,0x0A,0xB3), rgb_t(0xA2,0x19,0xC2), \
	rgb_t(0xB2,0x28,0xD2), rgb_t(0xC1,0x38,0xE1), rgb_t(0xD0,0x47,0xF0), rgb_t(0xE0,0x56,0xFF), \
	rgb_t(0xEF,0x65,0xFF), rgb_t(0xFE,0x75,0xFF), rgb_t(0xFF,0x84,0xFF), rgb_t(0xFF,0x93,0xFF), \
	rgb_t(0xFF,0xA3,0xFF), rgb_t(0xFF,0xB2,0xFF), rgb_t(0xFF,0xC1,0xFF), rgb_t(0xFF,0xD1,0xFF   )

#define NTSC_HUE6_PAL_HUE7_U2 \
	rgb_t(0x40,0x00,0xE0), rgb_t(0x50,0x04,0xEF), rgb_t(0x5F,0x13,0xFE), rgb_t(0x6E,0x22,0xFF), \
	rgb_t(0x7E,0x32,0xFF), rgb_t(0x8D,0x41,0xFF), rgb_t(0x9C,0x50,0xFF), rgb_t(0xAB,0x5F,0xFF), \
	rgb_t(0xBB,0x6F,0xFF), rgb_t(0xCA,0x7E,0xFF), rgb_t(0xD9,0x8D,0xFF), rgb_t(0xE9,0x9D,0xFF), \
	rgb_t(0xF8,0xAC,0xFF), rgb_t(0xFF,0xBB,0xFF), rgb_t(0xFF,0xCB,0xFF), rgb_t(0xFF,0xDA,0xFF   )

#define NTSC_HUE7_PAL_HUE8_U2 \
	rgb_t(0x03,0x06,0xFD), rgb_t(0x13,0x15,0xFF), rgb_t(0x22,0x25,0xFF), rgb_t(0x31,0x34,0xFF), \
	rgb_t(0x41,0x43,0xFF), rgb_t(0x50,0x53,0xFF), rgb_t(0x5F,0x62,0xFF), rgb_t(0x6E,0x71,0xFF), \
	rgb_t(0x7E,0x81,0xFF), rgb_t(0x8D,0x90,0xFF), rgb_t(0x9C,0x9F,0xFF), rgb_t(0xAC,0xAE,0xFF), \
	rgb_t(0xBB,0xBE,0xFF), rgb_t(0xCA,0xCD,0xFF), rgb_t(0xDA,0xDC,0xFF), rgb_t(0xE9,0xEC,0xFF   )

#define NTSC_HUE8_PAL_HUE9_U2 \
	rgb_t(0x00,0x1C,0xE7), rgb_t(0x00,0x2C,0xF6), rgb_t(0x00,0x3B,0xFF), rgb_t(0x00,0x4A,0xFF), \
	rgb_t(0x09,0x5A,0xFF), rgb_t(0x18,0x69,0xFF), rgb_t(0x27,0x78,0xFF), rgb_t(0x36,0x87,0xFF), \
	rgb_t(0x46,0x97,0xFF), rgb_t(0x55,0xA6,0xFF), rgb_t(0x64,0xB5,0xFF), rgb_t(0x74,0xC5,0xFF), \
	rgb_t(0x83,0xD4,0xFF), rgb_t(0x92,0xE3,0xFF), rgb_t(0xA2,0xF3,0xFF), rgb_t(0xB1,0xFF,0xFF   )

#define NTSC_HUE9_PAL_HUE10_U2 \
	rgb_t(0x00,0x32,0xA2), rgb_t(0x00,0x41,0xB1), rgb_t(0x00,0x51,0xC0), rgb_t(0x00,0x60,0xD0), \
	rgb_t(0x00,0x6F,0xDF), rgb_t(0x00,0x7E,0xEE), rgb_t(0x01,0x8E,0xFD), rgb_t(0x10,0x9D,0xFF), \
	rgb_t(0X20,0xAC,0xFF), rgb_t(0x2F,0xBC,0xFF), rgb_t(0x3E,0xCB,0xFF), rgb_t(0x4E,0xDA,0xFF), \
	rgb_t(0x5D,0xEA,0xFF), rgb_t(0x6C,0xF9,0xFF), rgb_t(0x7B,0xFF,0xFF), rgb_t(0x8B,0xFF,0xFF   )

#define NTSC_HUE10_PAL_HUE11_U2 \
	rgb_t(0x00,0x42,0x3D), rgb_t(0x00,0x51,0x4D), rgb_t(0x00,0x61,0x5C), rgb_t(0x00,0x70,0x6B), \
	rgb_t(0x00,0x7F,0x7A), rgb_t(0x00,0x8E,0x8A), rgb_t(0x00,0x9E,0x99), rgb_t(0x05,0xAD,0xA8), \
	rgb_t(0x14,0xBC,0xB8), rgb_t(0x23,0xCC,0xC7), rgb_t(0x33,0xDB,0xD6), rgb_t(0x42,0xEA,0xE6), \
	rgb_t(0x51,0xFA,0xF5), rgb_t(0x61,0xFF,0xFF), rgb_t(0x70,0xFF,0xFF), rgb_t(0x7F,0xFF,0xFF   )

#define NTSC_HUE11_PAL_HUE12_U2 \
	rgb_t(0x00,0x49,0x00), rgb_t(0x00,0x58,0x00), rgb_t(0x00,0x67,0x00), rgb_t(0x00,0x77,0x00), \
	rgb_t(0x00,0x86,0x0E), rgb_t(0x00,0x95,0x1D), rgb_t(0x07,0xA4,0x2C), rgb_t(0x17,0xB4,0x3C), \
	rgb_t(0x26,0xC3,0x4B), rgb_t(0x35,0xD2,0x5A), rgb_t(0x44,0xE2,0x6A), rgb_t(0x54,0xF1,0x79), \
	rgb_t(0x63,0xFF,0x88), rgb_t(0x72,0xFF,0x97), rgb_t(0x82,0xFF,0xA7), rgb_t(0x91,0xFF,0xB6   )

#define NTSC_HUE12_PAL_HUE13_U2 \
	rgb_t(0x00,0x45,0x00), rgb_t(0x00,0x54,0x00), rgb_t(0x00,0x63,0x00), rgb_t(0x04,0x73,0x00), \
	rgb_t(0x14,0x82,0x00), rgb_t(0x23,0x91,0x00), rgb_t(0x32,0xA0,0x00), rgb_t(0x41,0xB0,0x00), \
	rgb_t(0x51,0xBF,0x00), rgb_t(0x60,0xCE,0x00), rgb_t(0x6F,0xDE,0x0E), rgb_t(0x7F,0xED,0x1D), \
	rgb_t(0x8E,0xFC,0x2C), rgb_t(0x9D,0xFF,0x3C), rgb_t(0xAD,0xFF,0x4B), rgb_t(0xBC,0xFF,0x5A   )

#define NTSC_HUE13_PAL_HUE14_U2 \
	rgb_t(0x11,0x37,0x00), rgb_t(0x20,0x46,0x00), rgb_t(0x2F,0x55,0x00), rgb_t(0x3E,0x65,0x00), \
	rgb_t(0x4E,0x74,0x00), rgb_t(0x5D,0x83,0x00), rgb_t(0x6C,0x93,0x00), rgb_t(0x7C,0xA2,0x00), \
	rgb_t(0x8B,0xB1,0x00), rgb_t(0x9A,0xC0,0x00), rgb_t(0xAA,0xD0,0x00), rgb_t(0xB9,0xDF,0x00), \
	rgb_t(0xC8,0xEE,0x00), rgb_t(0xD7,0xFE,0x05), rgb_t(0xE7,0xFF,0x15), rgb_t(0xF6,0xFF,0x24   )

#define NTSC_HUE14_PAL_HUE15_U2 \
	rgb_t(0x4D,0x22,0x00), rgb_t(0x5C,0x31,0x00), rgb_t(0x6B,0x41,0x00), rgb_t(0x7B,0x50,0x00), \
	rgb_t(0x8A,0x5F,0x00), rgb_t(0x99,0x6F,0x00), rgb_t(0xA9,0x7E,0x00), rgb_t(0xB8,0x8D,0x00), \
	rgb_t(0xC7,0x9D,0x00), rgb_t(0xD7,0xAC,0x00), rgb_t(0xE6,0xBB,0x00), rgb_t(0xF5,0xCA,0x00), \
	rgb_t(0xFF,0xDA,0x00), rgb_t(0xFF,0xE9,0x01), rgb_t(0xFF,0xF8,0x10), rgb_t(0xFF,0xFF,0x20   )

#define  NTSC_HUE15_U2 \
	rgb_t(0x7D,0x0C,0x00), rgb_t(0x8D,0x1B,0x00), rgb_t(0x9C,0x2A,0x00), rgb_t(0xAB,0x39,0x00), \
	rgb_t(0xBB,0x49,0x00), rgb_t(0xCA,0x58,0x00), rgb_t(0xD9,0x67,0x00), rgb_t(0xE8,0x77,0x00), \
	rgb_t(0xF8,0x86,0x00), rgb_t(0xFF,0x95,0x00), rgb_t(0xFF,0xA5,0x02), rgb_t(0xFF,0xB4,0x11), \
	rgb_t(0xFF,0xC3,0x21), rgb_t(0xFF,0xD2,0x30), rgb_t(0xFF,0xE2,0x3F), rgb_t(0xFF,0xF1,0x4F   )

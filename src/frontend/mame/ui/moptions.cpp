...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_SKIP_PARTS_MENU,               "1",        OPTION_BOOLEAN,     "skip parts submenu, start with first part" },
	...
	{ OPTION_HIDE_PANELS "(0-3)",           "3",            OPTION_INTEGER,     "UI hide left/right panel in main view (0 = Show all, 1 = hide left, 2 = hide right, 3 = hide both" },

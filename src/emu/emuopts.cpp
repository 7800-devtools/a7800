...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_MEDIAPATH ";rp;biospath;bp",                "bios;roms",      OPTION_STRING,     "path to ROMsets and hard disk images" },
	...
	{ OPTION_SWPATH,                                     "roms;software",  OPTION_STRING,     "path to loose software" },

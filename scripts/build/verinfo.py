...
if build == "mess":
    ...
    author = "Mike Saarna and Team A7800"
    #//comments = "Multiple Arcade Machine Emulator"
    comments = "A7800 The Atari 7800 Emulator"
    #//company_name = "MAME Team"
    company_name = "Team A7800"
    #//file_description = "Multiple Arcade Machine Emulator"
    file_description = "A7800 The Atari 7800 Emulator"
    #//internal_name = "MAME" if build == "mame" else build
    internal_name = "A7800" if build == "mame" else build
    #//original_filename = "MAME" if build == "mame" else build
    original_filename = "A7800" if build == "mame" else build
    #//product_name = "MAME" if build == "mame" else build
    product_name = "A7800" if build == "mame" else build
    #//bundle_identifier = "org.mamedev." + build
    bundle_identifier = "org.7800.8bitdev." + build

#//legal_copyright = "Copyright Nicola Salmoria and the MAME team"
legal_copyright = "Copyright Mike Saarna and Team A7800"
